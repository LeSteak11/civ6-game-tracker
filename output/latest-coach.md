...
_Egypt (Cleopatra) — 725 BC / Classical Era — Chieftain / ? / -1837222328 Continents.lua — schema coach-snapshot/1 coach 0.1.0_
...
- 1 idle unit(s)
- 6 unit(s) with unspent promotion
...
- Military Training ★ — 120cul (5t) — unlocks: Raid, Veterancy
- Drama and Poetry  — 110cul (10t) — unlocks: Literary Tradition — inspiration: Build a wonder.
- Theology  — 120cul (11t) — unlocks: Scripture — inspiration: Found a Religion.
- Defensive Tactics  — 175cul (15t) — unlocks: Bastions, Limes — inspiration: Be the target of a Declaration of War.
- Recorded History  — 175cul (15t) — unlocks: Natural Philosophy — inspiration: Build 2 Campus districts.
- Naval Tradition  — 200cul (18t) — unlocks: Naval Infrastructure, Navigation — inspiration: Kill a unit with a Quadrireme.
- Feudalism  — 275cul (24t) — unlocks: Feudal Contract, Serfdom — inspiration: Build 6 Farms.
- Civil Service  — 275cul (24t) — unlocks: Retainers, Meritocracy — inspiration: Grow a city to 10 population.
- Mercenaries  — 290cul (26t) — unlocks: Sack, Professional Army, Trade Confederation — inspiration: Have 8 land combat units in your military.
...
## GREAT PEOPLE
- **GENERAL** 49pts (+1.1/turn) — next recruit cost 0
- **PROPHET** 25pts (+2.3/turn) — next recruit cost 0
...
- defense: str 23 | garrison 200/200 | walls 0/0
    ...
    - trade → player0 Luxis: FOO+1, PRO+1
### Sais @ (62,26)
...
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - tiles: 11 owned, 7 worked | terrain: 7 grass, 2 plains, 1 grass_hills, 1 plains_hills | features: 2 jungle, 1 marsh | improvements: 2 pasture, 1 plantation, 1 farm
...
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - tiles: 9 owned, 5 worked | terrain: 6 grass, 1 grass_hills, 1 coast, 1 plains | features: 1 forest, 1 marsh | improvements: 2 quarry, 1 farm, 1 sphinx
...
- defense: str 10 | garrison 200/200 | walls 0/0
    ...
    - tiles: 7 owned, 2 worked | terrain: 4 grass, 1 grass_hills, 1 plains, 1 grass_mountain | features: 1 jungle
...
## UNITS (6)
- **Scout** #196608 @(49,19) | hp100/100 | mv0/3 | cs10 rs0 xp15/45 (+1 avail)
- **Warrior** #131073 @(66,29) | hp84/100 | mv1/2 | cs20 rs0 xp7/15 (+1 avail) <IDLE>
- **Trader** #786434 @(65,24) | hp100/100 | mv0/2 | cs0 rs0 xp0/15 (+1 avail)
- **Warrior** #655363 @(62,26) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 (+1 avail) fort:2
- **Archer** #1048582 @(67,29) | hp100/100 | mv0/2 | cs15 rs25 xp22/45 (+1 avail)
- **Warrior** #983047 @(66,25) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 (+1 avail) fort:2
...
- per-query timing (s): meta=0.37, choices=0.331, cities=0.361, units=0.348, map=0.347, diplo=0.326, religion=0.343, notif=0.343
- **failures at runtime:**
    - `choices.CHOICES.probe`: cul:CanProgressCivic missing — falling back to !HasCivic
...
<!-- coach snapshot: schema=coach-snapshot/1 turn=87 generated_at=1785299738.532112 failed_sections=none -->
