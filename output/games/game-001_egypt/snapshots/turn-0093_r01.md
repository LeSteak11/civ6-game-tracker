# CIV6 COACH SNAPSHOT — turn 93
_Egypt (Cleopatra) — 575 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.2 coach 1.2.1_
...
## EMPIRE
- **score:** 95
- **gold:** 408 (net +13.6 = yield 15.6 − maint 2.0)
- **science:** 18.3/turn
- **culture:** 12.8/turn
- **faith:** 264 (+14.6/turn)
- **tourism:** 19.0/turn
- **military:** 127
- **techs / civics done:** 13 / 9
- **cities / units / pop:** 4 / 6 / 16
- **trade routes:** 1/1
...
## RESEARCH / CIVIC
- **tech:** Construction 198/200 (1t) — eureka:False [need: Build a Water Mill.]
- **civic:** Drama and Poetry 86/110 (2t) — inspiration:True

### TECHS AVAILABLE (up to 10, sorted by turns)
- Construction  — 200sci (1t) — unlocks: Siege Tower, Terracotta Army — boost: Build a Water Mill.
...
- Engineering  — 200sci (11t) — unlocks: Catapult, Aqueduct, Bath — boost: Build Ancient Walls.
- Apprenticeship  — 300sci (17t) — unlocks: Man-At-Arms, Workshop, Industrial Zone, Hansa — boost: Build 3 Mines.
- Stirrups  — 390sci (22t) — unlocks: Knight, Mamluk — boost: Have the Feudalism civic.

### CIVICS AVAILABLE (up to 10, sorted by turns)
- Drama and Poetry ★ — 110cul (2t) — unlocks: Literary Tradition
...
- **current:** Construction — 198/200sci (1t)
- **available now:** 7 (top picks listed above)
- **blocked:** 47 — nearest 8, missing prereqs:
...
### CIVIC TREE (9/51 completed)
- **completed:** Code of Laws, Craftsmanship, Foreign Trade, Military Tradition, State Workforce, Early Empire, Mysticism, Games and Recreation, Political Philosophy
- **current:** Drama and Poetry — 86/110cul (2t)
- **available now:** 2 (top picks listed above)
- **partially banked:** Military Training (60/120cul), Theology (60/120cul)
- **blocked:** 39 — nearest 8, missing prereqs:
...
## GREAT PEOPLE
- **GENERAL** 56pts (+1.2/turn) — next recruit cost 60 — candidate: Sun Tzu
...
- **SCIENTIST** 9pts (+2.3/turn) — next recruit cost 120 — candidate: Abu al-Qasim al-Zahrawi
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 18t (food+1.0) | hous 10 | amen 3/1 | happ 5 | border+6t
- yields: F7.0 P12.8 G10.5 S8.5 C6.2 Fa13.6
- **producing:** Water Mill (64/80, 2t)
...
- majority religion: RELIGION_TAOISM
    ...
    - tiles: 15 owned, 4 worked | terrain: 8 plains, 5 plains_hills, 1 grass_hills, 1 grass | features: 1 marsh, 1 forest | improvements: 3 farm, 2 sphinx, 2 mine, 1 camp
    - top production options: Water Mill (2t), Scout (3t), Warrior (3t), Trader (5t), Archer (5t), Spearman (5t), Battering Ram (5t), Builder (6t), Horseman (6t), Ancient Walls (7t)
    - ...11 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 6 | grow 1t (food+8.0) | hous 7 | amen 1/2 | happ 3 | border+20t
- yields: F20.0 P6.7 G1.9 S4.0 C3.6 Fa0.0
- **producing:** Holy Site (122/131, 2t)
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - tiles: 12 owned, 7 worked | terrain: 8 grass, 2 plains, 1 plains_hills, 1 grass_hills | features: 2 jungle, 1 marsh | improvements: 2 pasture, 1 plantation, 1 farm
    - top production options: Holy Site (2t), Scout (5t), Warrior (7t), Trader (10t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Builder (12t), Horseman (13t)
    - ...10 more options in JSON
### SHEDET @ (66,25)
- pop 5 | grow 51t (food+5.0) | hous 5 | amen 1/2 | happ 3 | border+7t
- yields: F15.0 P7.6 G0.0 S3.3 C2.4 Fa1.0
- **producing:** Granary (55/65, 2t)
- defense: str 20 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (66,25)
    - tiles: 9 owned, 6 worked | terrain: 6 grass, 1 grass_hills, 1 coast, 1 plains | features: 1 marsh, 1 forest | improvements: 2 quarry, 1 sphinx, 1 farm
    - top production options: Granary (2t), Scout (4t), Builder (5t), Warrior (6t), Archer (8t), Monument (8t), Trader (9t), Spearman (9t), Battering Ram (9t), Horseman (11t)
    - ...11 more options in JSON
### Luxis @ (64,22)
- pop 2 | grow 7t (food+2.0) | hous 5 | amen 1/0 | happ 5 | border+9t
- yields: F6.0 P4.2 G3.1 S2.5 C0.6 Fa0.0
- **producing:** Monument (38/60, 6t)
- defense: str 10 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - tiles: 7 owned, 3 worked | terrain: 4 grass, 1 grass_hills, 1 grass_mountain, 1 plains | features: 1 jungle
    - top production options: Monument (6t), Scout (8t), Warrior (10t), Trader (15t), Archer (15t), Spearman (16t), Battering Ram (16t), Granary (16t), Builder (19t), Horseman (20t)
    - ...11 more options in JSON

## UNITS (6)
- **Scout** #196608 @(49,21) | hp88/100 | mv3/3 | cs10 rs0 xp16/45 fort:2
- **Warrior** #131073 @(66,29) | hp100/100 | mv2/2 | cs20 rs0 xp7/15 fort:2
- **Trader** #786434 @(65,25) | hp100/100 | mv2/2 | cs0 rs0 xp0/15
- **Warrior** #655363 @(62,26) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 fort:2
- **Archer** #1048582 @(67,29) | hp100/100 | mv2/2 | cs15 rs25 xp22/45 fort:2
- **Warrior** #983047 @(66,25) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 fort:2

## DIPLOMACY
- **envoys:** 0 in hand | 26/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 112 mil 139 | met T27 | OB from them
### CITY-STATES MET
...
## REVEALED MAP
_529 revealed, 103 currently visible, 1 natural wonders_
...
- per-query timing (s): meta=0.366, choices=0.36, cities=0.358, units=0.346, map=0.36, diplo=0.328, religion=0.342, notif=0.389
...
<!-- coach snapshot: schema=coach-snapshot/1.2 turn=93 generated_at=1785309068.2855406 failed_sections=none -->
