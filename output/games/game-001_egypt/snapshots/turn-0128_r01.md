# CIV6 COACH SNAPSHOT — turn 128
_Egypt (Cleopatra) — 300 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## EMPIRE
- **score:** 132
- **gold:** 542 (net +8.2 = yield 20.2 − maint 12.0)
- **science:** 23.8/turn
- **culture:** 20.0/turn
- **faith:** 1013 (+26.9/turn)
- **tourism:** 20.0/turn
- **military:** 190
- **techs / civics done:** 18 / 14
- **cities / units / pop:** 4 / 8 / 24
- **trade routes:** 1/1
...
## RESEARCH / CIVIC
- **tech:** Shipbuilding 119/200 (4t) — eureka:False [need: Own 2 Galleys.]
- **civic:** Recorded History 128/175 (3t) — inspiration:False [need: Build 2 Campus districts.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Shipbuilding  — 200sci (4t) — unlocks: Quadrireme, Colossus — boost: Own 2 Galleys.
...
- Recorded History  — 175cul (3t) — unlocks: Natural Philosophy — inspiration: Build 2 Campus districts.
...
- **current:** Shipbuilding — 119/200sci (4t)
...
- **current:** Recorded History — 128/175cul (3t)
...
## GREAT PEOPLE
- **GENERAL** 61pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
- **ADMIRAL** 0pts (+0.0/turn) — next recruit cost 120 — candidate: Leif Erikson
- **ENGINEER** 6pts (+1.2/turn) — next recruit cost 120 — candidate: Bi Sheng
- **MERCHANT** 0pts (+0.0/turn) — next recruit cost 60 — candidate: Zhang Qian
- **PROPHET** 99pts (+3.5/turn) — next recruit cost 240 — candidate: Martin Luther
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options (showing 10 of 25): Scout (2t), Workshop (2t), Trader (3t), Archer (3t), Spearman (3t), Battering Ram (3t), Horseman (3t), Builder (4t), Siege Tower (4t), Catapult (5t)
...
### Sais @ (62,26)
- pop 7 | grow 12t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+7t | growth -15%
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa11.4
- prod sources: tiles 6.0, other +0.7 (see JSON for all yields)
- **producing:** Granary (34/65, 5t)
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 27): Scout (5t), Granary (5t), Archer (10t), Spearman (10t), Battering Ram (10t), Trader (11t), Horseman (13t), Ancient Walls (13t), Water Mill (13t), Builder (15t)
    ...
    - unavailable (showing 6 of 44; full list + reasons in JSON):
        ...
        - Library — This building requires a Campus district.
### SHEDET @ (66,25)
- pop 7 | grow 10t (food+8.0) | hous 8 | amen 1/3 | happ Displeased | border+2t | growth -15%
- yields: F22.0 P8.6 G2.9 S4.7 C5.8 Fa1.9
- prod sources: tiles 8.0, other +0.6 (see JSON for all yields)
- **producing:** Water Mill (44/80, 5t)
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - top production options (showing 10 of 25): Scout (4t), Water Mill (5t), Archer (8t), Spearman (8t), Battering Ram (8t), Trader (9t), Horseman (10t), Builder (12t), Siege Tower (12t), Catapult (15t)
    - ...15 more options in JSON
...
- defense: str 35 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 26): Builder (1t), Scout (5t), Archer (10t), Spearman (11t), Battering Ram (11t), Trader (12t), Horseman (14t), Ancient Walls (14t), Water Mill (14t), Siege Tower (17t)
...
## UNITS (8)
- **Scout** #1835009 @(73,16) | hp100/100 | mv3/3 | cs10 rs0 xp0/15
...
## DIPLOMACY
- **envoys:** 1 in hand | 51/100 pts (+5.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 166 mil 172 | met T27 | OB from them
...
## REVEALED MAP
_627 revealed, 147 currently visible, 1 natural wonders_
...
63,17 0|d|||||||0|||
64,17 1|p|jun||||||0|||
65,17 1|p|jun||||||0|11:SWORDSMAN:100|A-1|
66,17 1|d||||1|||0||A-1|
...
63,18 0|g|for||||||0||A1|
64,18 1|g|for||||||0|7:ARCHER:100|A2|
65,18 1|g|||||||0|||
...
65,20 1|g||||1|||0|11:SWORDSMAN:100|A2|
...
- per-query timing (s): meta=0.372, choices=0.36, cities=0.392, units=0.329, map=0.363, diplo=0.361, religion=0.346, notif=0.329
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=128 generated_at=1785314809.2334003 failed_sections=none counts: cities=4 units=8 tiles=627 majors=1 city_states=4 gossip=20 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=36715 -->
