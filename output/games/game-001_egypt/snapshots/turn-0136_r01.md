# CIV6 COACH SNAPSHOT — turn 136
_Egypt (Cleopatra) — 500 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## RESEARCH / CIVIC
- **tech:** Celestial Navigation 117/120 (1t) — eureka:False [need: Improve 2 sea resources.]
- **civic:** Civil Service 117/275 (8t) — inspiration:False [need: Grow a city to 10 population.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Celestial Navigation  — 120sci (1t) — unlocks: Lighthouse, Great Lighthouse, Harbor, Royal Navy Dockyard — boost: Improve 2 sea resources.
...
- Civil Service  — 275cul (8t) — unlocks: Retainers, Meritocracy — inspiration: Grow a city to 10 population.
...
- **current:** Celestial Navigation — 117/120sci (1t)
...
- **current:** Civil Service — 117/275cul (8t)
...
## GREAT PEOPLE
- **GENERAL** 80pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
- **ADMIRAL** 0pts (+0.0/turn) — next recruit cost 120 — candidate: Leif Erikson
- **ENGINEER** 22pts (+2.4/turn) — next recruit cost 120 — candidate: Bi Sheng
- **MERCHANT** 0pts (+0.0/turn) — next recruit cost 60 — candidate: Zhang Qian
- **PROPHET** 127pts (+3.6/turn) — next recruit cost 240 — candidate: Martin Luther
- **SCIENTIST** 91pts (+2.4/turn) — next recruit cost 240 — candidate: Emilie du Chatelet
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 5 | grow STARVE 26t (food-1.0) | hous 12 | amen 4/2 | happ Happy | border+1t | growth +10%
...
- majority religion: RELIGION_TAOISM
    ...
    - tiles: 17 owned, 6 worked | terrain: 9 plains, 5 plains_hills, 1 grass_hills, 1 coast, 1 grass | improvements: 6 farm, 3 mine, 2 sphinx, 1 camp
    - top production options (showing 10 of 25): Scout (1t), Trader (2t), Archer (2t), Spearman (2t), Battering Ram (2t), Builder (3t), Horseman (3t), Siege Tower (3t), Catapult (4t), Maryannu Chariot Archer (4t)
...
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 27): Scout (5t), Water Mill (8t), Archer (9t), Spearman (10t), Battering Ram (10t), Trader (11t), Horseman (12t), Ancient Walls (12t), Builder (15t), Siege Tower (15t)
...
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - tiles: 12 owned, 8 worked | terrain: 8 grass, 1 grass_mountain, 1 plains, 1 coast, 1 grass_hills | features: 1 forest, 1 marsh | improvements: 3 farm, 3 quarry, 2 sphinx
    - top production options (showing 10 of 25): Archer (3t), Scout (4t), Spearman (7t), Battering Ram (7t), Trader (8t), Horseman (9t), Builder (11t), Siege Tower (11t), Catapult (13t), Maryannu Chariot Archer (13t)
    - ...15 more options in JSON
    - unavailable (showing 6 of 48; full list + reasons in JSON):
        ...
        - Shrine — This building requires a Holy Site district.
### Luxis @ (64,22)
- pop 5 | grow 5t (food+5.0) | hous 8 | amen 2/2 | happ Content | border+18t
- yields: F15.0 P7.0 G8.0 S4.5 C3.5 Fa1.0
- prod sources: tiles 6.0, other +1.0 (see JSON for all yields)
- **producing:** Water Mill (48/80, 5t)
- defense: str 35 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - buildings in `CITY_CENTER`: Monument, Granary
    - tiles: 11 owned, 6 worked | terrain: 7 grass, 1 grass_mountain, 1 plains, 1 plains_hills, 1 grass_hills | features: 2 jungle, 2 forest | improvements: 1 farm, 1 plantation
    - top production options (showing 10 of 27): Scout (5t), Water Mill (5t), Archer (9t), Spearman (10t), Battering Ram (10t), Trader (11t), Horseman (12t), Ancient Walls (12t), Builder (15t), Siege Tower (15t)
    - ...17 more options in JSON
    - unavailable (showing 6 of 48; full list + reasons in JSON):
        - Great Library — Requires Library [reconstructed: BuildingPrereqs]
        - Stonehenge — blocked (reason not exposed by engine)
...
## UNITS (10)
- **Builder** #1900544 @(63,23) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch3 <IDLE>
- **Scout** #1835009 @(73,10) | hp78/100 | mv3/3 | cs10 rs0 xp15/15 fort:2
...
- **Settler** #1966088 @(66,29) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 <IDLE>
- **Man-At-Arms** #1769481 @(66,29) | hp100/100 | mv3/3 | cs45 rs0 xp15/45

## DIPLOMACY
- **envoys:** 0 in hand | 91/100 pts (+5.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 180 mil 129 | met T27
...
- `NOTIFICATION_CITY_STARVING`: City Starving!
...
## REVEALED MAP
_657 revealed, 198 currently visible, 2 natural wonders_
...
66,21 1|g||||1|||0|11:SWORDSMAN:100|A2|
67,21 1|g|||||||0|||
...
56,22 1|g|||||||0||R/F|
57,22 1|g||HORSES|PASTURE||8||0|8:WARRIOR:100|R/A2/F|
58,22 1|g|for||||||0||A1|
59,22 0|g|||||||0||R/A4/F|
60,22 0|gm|||||||0||A4|
61,22 1|gh|||||||0|||
...
61,23 1|gm|||||||0||A4|
62,23 1|gm|||||||0||A4|
63,23 1|gh||IRON|||0||0|0:BUILDER:100|A2|
...
66,29 1|ph||||1|0|CITY_CENTER|1|0:GREAT_GENERAL:100;0:MAN_AT_ARMS:100;0:SETTLER:100|R/F|Râ-Kedet
...
- per-query timing (s): meta=0.372, choices=0.359, cities=0.39, units=0.344, map=0.361, diplo=0.363, religion=0.345, notif=0.344
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=136 generated_at=1785315734.5160432 failed_sections=none counts: cities=4 units=10 tiles=657 majors=1 city_states=4 gossip=22 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=38512 -->
