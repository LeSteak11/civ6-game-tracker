# CIV6 COACH SNAPSHOT — turn 104
_Egypt (Cleopatra) — 300 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.4.0_
...
## EMPIRE
- **score:** 112
- **gold:** 564 (net +14.2 = yield 17.2 − maint 3.0)
- **science:** 20.3/turn
- **culture:** 15.7/turn
- **faith:** 462 (+20.3/turn)
- **tourism:** 19.0/turn
...
## RESEARCH / CIVIC
- **tech:** Iron Working 40/120 (4t) — eureka:False [need: Build an Iron Mine.]
- **civic:** none 0/0 (-1t) — inspiration:False

### TECHS AVAILABLE (up to 10, sorted by turns)
- Iron Working  — 120sci (4t) — unlocks: Swordsman, Legion, Ngao Mbeba — boost: Build an Iron Mine.
...
- **current:** Iron Working — 40/120sci (4t)
...
- **luxuries:** Ivory
- **owned bonus tiles:** 3× Stone (2/3 improved), 2× Bananas (1/2 improved), 2× Cattle, 2× Rice (1/2 improved), Fish (0/1 improved)
...
## GREAT PEOPLE
- **GENERAL** 8pts (+1.2/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 38pts (+1.2/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 35pts (+2.3/turn) — next recruit cost 120 — candidate: Omar Khayyam
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 4 | grow 38t (food+1.0) | hous 10 | amen 3/1 | happ Happy | border+13t | growth +10%
- yields: F9.0 P17.3 G9.4 S9.2 C6.5 Fa12.6
- **producing:** Barracks (43/90, 3t)
...
- majority religion: RELIGION_TAOISM
    ...
    - tiles: 16 owned, 5 worked | terrain: 9 plains, 5 plains_hills, 1 grass, 1 grass_hills | features: 1 marsh | improvements: 4 farm, 2 mine, 2 sphinx, 1 camp
    - top production options: Scout (2t), Warrior (3t), Barracks (3t), Trader (4t), Archer (4t), Spearman (4t), Battering Ram (4t), Builder (5t), Horseman (5t), Siege Tower (6t)
    - ...15 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 7 | grow 36t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+7t | growth -15%
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa5.7
- **producing:** Shrine (64/70, 1t)
- defense: str 22 | garrison 200/200 | walls 0/0
    ...
    - top production options: Shrine (1t), Scout (5t), Warrior (7t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Trader (11t), Builder (13t), Horseman (13t)
    - ...18 more options in JSON
### SHEDET @ (66,25)
- pop 5 | grow 1t (food+6.0) | hous 8 | amen 1/2 | happ Displeased | border+18t | growth -15%
- yields: F16.0 P7.6 G2.9 S3.3 C2.4 Fa1.0
- **producing:** Monument (15/60, 6t)
- defense: str 23 | garrison 200/200 | walls 100/100
    ...
    - top production options: Scout (4t), Warrior (6t), Monument (6t), Archer (8t), Trader (9t), Spearman (9t), Battering Ram (9t), Horseman (11t), Water Mill (11t), Builder (12t)
    - ...15 more options in JSON
### Luxis @ (64,22)
- pop 3 | grow 13t (food+2.0) | hous 5 | amen 1/1 | happ Content | border+2t
- yields: F8.0 P5.0 G3.0 S3.1 C2.9 Fa1.0
- **producing:** Granary (28/65, 8t)
- defense: str 10 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (6t), Warrior (8t), Granary (8t), Archer (12t), Spearman (13t), Battering Ram (13t), Trader (14t), Horseman (16t), Ancient Walls (16t), Water Mill (16t)
    - ...16 more options in JSON

## UNITS (9)
- **Scout** #196608 @(56,20) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
...
- **Builder** #1376260 @(67,26) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch1 <IDLE>
...
- **Builder** #1441800 @(65,28) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch1 <IDLE>

## DIPLOMACY
- **envoys:** 1 in hand | 59/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 132 mil 129 | met T27
...
- `NOTIFICATION_CIVIC_DISCOVERED`: Discovered Military Training
- `NOTIFICATION_COMMAND_UNITS` [BLOCKS: ENDTURN_BLOCKING_UNITS]: Command Units

## REVEALED MAP
_591 revealed, 145 currently visible, 1 natural wonders_
...
68,18 0|d||||1|11|COMMERCIAL_HUB|0||A2/F|
69,18 0|d|||||||0||A1/F|
70,18 0|p|jun||||||0||A1|
71,18 0|p|for||||||0|||
72,18 0|d|||||||0||A1|
...
67,26 1|gh||STONE|||0||0|0:BUILDER:100|R/A1/F|
68,26 1|co|||||||0|||
69,26 1|oc|||||||0|||
52,27 0|co|||||||0|||
53,27 0|co|||||||0|||
...
64,28 1|p||WHEAT||1|||0|||
65,28 1|ph|||||0||0|0:BUILDER:100|A1|
...
64,29 1|p|||FARM|1|0||0||A1|
65,29 1|p|||FARM|1|0||0||R/A1/F|
...
- per-query timing (s): meta=0.381, choices=0.361, cities=0.373, units=0.343, map=0.359, diplo=0.343, religion=0.343, notif=0.343
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=104 generated_at=1785311308.4393473 failed_sections=none -->
