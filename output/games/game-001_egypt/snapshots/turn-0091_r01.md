# CIV6 COACH SNAPSHOT — turn 91
_Egypt (Cleopatra) — 625 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.2 coach 1.2.1_
...
## EMPIRE
- **score:** 92
- **gold:** 381 (net +13.6 = yield 15.6 − maint 2.0)
- **science:** 17.8/turn
- **culture:** 12.6/turn
- **faith:** 235 (+14.6/turn)
- **tourism:** 19.0/turn
...
## RESEARCH / CIVIC
- **tech:** Construction 162/200 (3t) — eureka:False [need: Build a Water Mill.]
- **civic:** none 0/0 (-1t) — inspiration:False

### TECHS AVAILABLE (up to 10, sorted by turns)
- Construction  — 200sci (3t) — unlocks: Siege Tower, Terracotta Army — boost: Build a Water Mill.
...
- Drama and Poetry ★ — 110cul (4t) — unlocks: Literary Tradition
...
- **current:** Construction — 162/200sci (3t)
...
## GREAT PEOPLE
- **GENERAL** 53pts (+1.2/turn) — next recruit cost 60 — candidate: Sun Tzu
...
- **SCIENTIST** 5pts (+2.3/turn) — next recruit cost 120 — candidate: Abu al-Qasim al-Zahrawi
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 20t (food+1.0) | hous 10 | amen 3/1 | happ 5 | border+8t
- yields: F7.0 P12.8 G10.5 S8.5 C6.2 Fa13.6
- **producing:** Water Mill (38/80, 4t)
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options: Scout (3t), Warrior (3t), Water Mill (4t), Trader (5t), Archer (5t), Spearman (5t), Battering Ram (5t), Builder (6t), Horseman (6t), Ancient Walls (7t)
    - ...11 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 6 | grow 3t (food+8.0) | hous 7 | amen 1/2 | happ 3 | border+2t
- yields: F20.0 P6.7 G1.9 S4.0 C3.6 Fa0.0
- **producing:** Holy Site (109/131, 4t)
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - top production options: Holy Site (4t), Scout (5t), Warrior (7t), Trader (10t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Builder (12t), Horseman (13t)
    - ...10 more options in JSON
### SHEDET @ (66,25)
- pop 4 | grow 1t (food+5.0) | hous 5 | amen 1/1 | happ 4 | border+10t
- yields: F13.0 P6.0 G0.0 S2.8 C2.2 Fa1.0
- **producing:** Granary (42/65, 4t)
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - top production options: Granary (4t), Scout (5t), Builder (6t), Warrior (7t), Archer (10t), Monument (10t), Trader (11t), Spearman (11t), Battering Ram (11t), Horseman (14t)
    - ...11 more options in JSON
### Luxis @ (64,22)
- pop 2 | grow 9t (food+2.0) | hous 5 | amen 1/0 | happ 5 | border+11t
- yields: F6.0 P4.2 G3.1 S2.5 C0.6 Fa0.0
- **producing:** Monument (30/60, 8t)
- defense: str 10 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (8t), Monument (8t), Warrior (10t), Trader (15t), Archer (15t), Spearman (16t), Battering Ram (16t), Granary (16t), Builder (19t), Horseman (20t)
    - ...11 more options in JSON

## UNITS (6)
- **Scout** #196608 @(49,21) | hp68/100 | mv3/3 | cs10 rs0 xp16/45 fort:2
...
## DIPLOMACY
- **envoys:** 0 in hand | 20/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 109 mil 139 | met T27 | OB from them
### CITY-STATES MET
...
- **units visible (1):** Galley @(68,29) hp72/100

## NOTIFICATIONS
- `NOTIFICATION_WONDER_COMPLETED`: Wonder Completed
- `NOTIFICATION_PLAYER_DEFEATED`: Defeated!
- `NOTIFICATION_CIVIC_DISCOVERED`: Discovered Military Tradition
...
60,22 0|gm|||||||0||A4|
61,22 0|gh|||||||0|||
62,22 1|ph|jun||||||0|7:WARRIOR:100|A2|
63,22 1|g|||||0||0|||
...
- per-query timing (s): meta=0.382, choices=0.364, cities=0.362, units=0.332, map=0.362, diplo=0.346, religion=0.344, notif=0.346
...
<!-- coach snapshot: schema=coach-snapshot/1.2 turn=91 generated_at=1785308693.9315586 failed_sections=none -->
