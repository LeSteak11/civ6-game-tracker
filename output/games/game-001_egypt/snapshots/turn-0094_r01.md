# CIV6 COACH SNAPSHOT — turn 94
_Egypt (Cleopatra) — 550 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.2 coach 1.2.1_
...
## EMPIRE
- **score:** 95
- **gold:** 422 (net +13.6 = yield 15.6 − maint 2.0)
- **science:** 19.0/turn
- **culture:** 13.1/turn
- **faith:** 279 (+14.6/turn)
- **tourism:** 19.0/turn
- **military:** 129
- **techs / civics done:** 14 / 9
...
- **civic:** Drama and Poetry 99/110 (1t) — inspiration:True
...
- Iron Working  — 120sci (6t) — unlocks: Swordsman, Legion, Ngao Mbeba — boost: Build an Iron Mine.
...
- Engineering  — 200sci (10t) — unlocks: Catapult, Aqueduct, Bath — boost: Build Ancient Walls.
...
- Drama and Poetry ★ — 110cul (1t) — unlocks: Literary Tradition
...
- **current:** Drama and Poetry — 99/110cul (1t)
...
## GREAT PEOPLE
- **GENERAL** 57pts (+1.2/turn) — next recruit cost 60 — candidate: Sun Tzu
...
- **SCIENTIST** 12pts (+2.3/turn) — next recruit cost 120 — candidate: Abu al-Qasim al-Zahrawi
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 17t (food+1.0) | hous 10 | amen 3/1 | happ 5 | border+5t
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options: Water Mill (1t), Scout (3t), Warrior (3t), Trader (5t), Archer (5t), Spearman (5t), Battering Ram (5t), Builder (6t), Horseman (6t), Siege Tower (7t)
    - ...13 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 7 | grow 46t (food+8.0) | hous 7 | amen 1/3 | happ 3 | border+17t
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa0.0
- **producing:** Holy Site (129/131, 1t)
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - top production options: Holy Site (1t), Scout (5t), Warrior (7t), Trader (10t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Builder (12t), Horseman (13t)
    - ...12 more options in JSON
### SHEDET @ (66,25)
- pop 5 | grow 50t (food+5.0) | hous 5 | amen 1/2 | happ 3 | border+6t
...
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - top production options: Granary (1t), Scout (4t), Builder (5t), Warrior (6t), Archer (8t), Monument (8t), Trader (9t), Spearman (9t), Battering Ram (9t), Horseman (11t)
    - ...13 more options in JSON
### Luxis @ (64,22)
- pop 2 | grow 6t (food+2.0) | hous 5 | amen 1/0 | happ 5 | border+8t
- yields: F6.0 P4.2 G3.1 S2.5 C0.6 Fa0.0
- **producing:** Monument (43/60, 5t)
- defense: str 10 | garrison 200/200 | walls 0/0
    ...
    - top production options: Monument (5t), Scout (8t), Warrior (10t), Archer (15t), Trader (16t), Spearman (16t), Battering Ram (16t), Granary (16t), Builder (19t), Horseman (20t)
    - ...13 more options in JSON

## UNITS (6)
- **Scout** #196608 @(49,21) | hp98/100 | mv3/3 | cs10 rs0 xp16/45 fort:2
...
## DIPLOMACY
- **envoys:** 0 in hand | 29/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_FRIENDLY | vis 1 | score 114 mil 152 | met T27 | OB from them
### CITY-STATES MET
...
- **units visible (1):** Warrior @(66,31) hp100/100
...
- `NOTIFICATION_TECH_DISCOVERED`: Discovered Construction
...
- per-query timing (s): meta=0.371, choices=0.372, cities=0.361, units=0.344, map=0.358, diplo=0.345, religion=0.345, notif=0.346
...
<!-- coach snapshot: schema=coach-snapshot/1.2 turn=94 generated_at=1785309223.6018178 failed_sections=none -->
