# CIV6 COACH SNAPSHOT — turn 100
_Egypt (Cleopatra) — 400 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.3 coach 1.3.0_
...
## EMPIRE
- **score:** 106
- **gold:** 507 (net +14.2 = yield 17.2 − maint 3.0)
- **science:** 19.6/turn
- **culture:** 15.4/turn
- **faith:** 380 (+17.4/turn)
- **tourism:** 19.0/turn
- **military:** 137
- **techs / civics done:** 14 / 11
- **cities / units / pop:** 4 / 9 / 18
- **trade routes:** 1/1
- **explored land:** 443/1153 tiles
- **enabled victories:** VICTORY_TECHNOLOGY, VICTORY_CULTURE, VICTORY_RELIGIOUS, VICTORY_CONQUEST, VICTORY_SCORE

## RESEARCH / CIVIC
- **tech:** Engineering 131/200 (4t) — eureka:False [need: Build Ancient Walls.]
- **civic:** none 0/0 (-1t) — inspiration:False

### TECHS AVAILABLE (up to 10, sorted by turns)
- Engineering  — 200sci (4t) — unlocks: Catapult, Aqueduct, Bath — boost: Build Ancient Walls.
...
- Defensive Tactics  — 175cul (11t) — unlocks: Bastions, Limes — inspiration: Be the target of a Declaration of War.
...
- **current:** Engineering — 131/200sci (4t)
...
## GOVERNMENT & POLICIES
- **government:** Classical Republic — 1 open slot(s) — free change avail: True
- **slotted:**
...
## GREAT PEOPLE
- **GENERAL** 4pts (+1.2/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 33pts (+1.2/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 25pts (+2.3/turn) — next recruit cost 120 — candidate: Omar Khayyam
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 3t (food+2.0) | hous 10 | amen 3/1 | happ 5 | border+18t
- yields: F8.0 P13.9 G9.4 S8.5 C6.2 Fa12.6
...
- majority religion: RELIGION_TAOISM
    ...
    - tiles: 16 owned, 4 worked | terrain: 9 plains, 5 plains_hills, 1 grass, 1 grass_hills | features: 1 forest, 1 marsh | improvements: 3 farm, 2 sphinx, 2 mine, 1 camp
    - top production options: Scout (2t), Warrior (3t), Trader (4t), Archer (4t), Spearman (4t), Battering Ram (4t), Horseman (5t), Builder (6t), Siege Tower (6t), Ancient Walls (6t)
    - ...14 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 7 | grow 40t (food+8.0) | hous 7 | amen 2/3 | happ 3 | border+11t
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa2.9
- **producing:** Shrine (38/70, 5t)
- defense: str 22 | garrison 200/200 | walls 0/0
    ...
    - tiles: 12 owned, 8 worked | terrain: 8 grass, 2 plains, 1 plains_hills, 1 grass_hills | features: 2 jungle, 1 marsh | improvements: 2 pasture, 1 farm, 1 plantation
    - top production options: Scout (5t), Shrine (5t), Warrior (7t), Trader (10t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Builder (13t), Horseman (13t)
    - ...16 more options in JSON
### SHEDET @ (66,25)
- pop 5 | grow 5t (food+6.0) | hous 7 | amen 1/2 | happ 3 | border+22t
- yields: F16.0 P7.6 G2.9 S3.3 C2.4 Fa1.0
- **producing:** Ancient Walls (8/80, 10t)
- defense: str 20 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (66,25)
    - buildings in `CITY_CENTER`: Granary
    - tiles: 10 owned, 6 worked | terrain: 7 grass, 1 coast, 1 plains, 1 grass_hills | features: 2 forest, 1 marsh | improvements: 2 quarry, 1 farm, 1 sphinx
    - top production options: Scout (4t), Warrior (6t), Archer (8t), Monument (8t), Trader (9t), Spearman (9t), Battering Ram (9t), Ancient Walls (10t), Horseman (11t), Water Mill (11t)
    - ...14 more options in JSON
### Luxis @ (64,22)
- pop 3 | grow 17t (food+2.0) | hous 5 | amen 1/1 | happ 4 | border+6t
- yields: F8.0 P5.0 G3.0 S3.1 C2.9 Fa1.0
- **producing:** Granary (8/65, 12t)
- defense: str 10 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - buildings in `CITY_CENTER`: Monument
    - tiles: 8 owned, 4 worked | terrain: 5 grass, 1 grass_mountain, 1 plains, 1 grass_hills | features: 1 jungle, 1 forest
    - top production options: Scout (6t), Warrior (8t), Archer (12t), Granary (12t), Trader (13t), Spearman (13t), Battering Ram (13t), Horseman (16t), Ancient Walls (16t), Water Mill (16t)
    - ...14 more options in JSON

## UNITS (9)
- **Scout** #196608 @(52,22) | hp100/100 | mv0/3 | cs10 rs0 xp16/45
...
- **Builder** #1376260 @(67,24) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch3
...
- **Builder** #1441800 @(66,29) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch3 <IDLE>

## DIPLOMACY
- **envoys:** 1 in hand | 47/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 128 mil 144 | met T27
...
- **Hattusa** (HATTUSA) — envoys sent 2 | suz: none | @(56,24) | met T19 | envoys: me (Egypt) 2, Sumeria 2
...
- Amsterdam (city-state): 1 unit(s) — ARCHER
...
- `NOTIFICATION_CIVIC_DISCOVERED`: Discovered Theology
...
## REVEALED MAP
_550 revealed, 111 currently visible, 1 natural wonders_
...
65,22 1|gm|||||0||0||R/A4|
66,22 1|g|for||||||0||A4|
67,22 1|g||||1|||0|11:ARCHER:100|A2|
68,22 1|g|||||||0||A2|
70,22 0|co||FISH|||||0|||
71,22 0|co|||||||0|||
46,23 0|co||CRABS|||||0|||
...
67,24 1|g||STONE|QUARRY||0||0|0:BUILDER:100|R/A5/F|
68,24 1|co|||||||0|||
69,24 1|oc|||||||0|||
47,25 0|oc|||||||0|||
48,25 0|oc|||||||0|||
...
66,29 1|ph||||1|0|CITY_CENTER|1|0:WARRIOR:100;0:GREAT_GENERAL:100;0:BUILDER:100|R/F|Râ-Kedet
...
- per-query timing (s): meta=0.372, choices=0.361, cities=0.377, units=0.341, map=0.377, diplo=0.36, religion=0.345, notif=0.342
...
<!-- coach snapshot: schema=coach-snapshot/1.3 turn=100 generated_at=1785310517.9923708 failed_sections=none -->
