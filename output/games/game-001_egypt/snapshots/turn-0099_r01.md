# CIV6 COACH SNAPSHOT — turn 99
_Egypt (Cleopatra) — 425 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.2 coach 1.2.1_

## CHANGES SINCE LAST SNAPSHOT
- turns elapsed: 1
- empire: gold: +15.400000000000034, culture: +2.0999999999999996, faith: +17.399999999999977, military: +1, num_units: +1, explored_land: +4
- newly revealed tiles: 8 (sample: (64,19) g, (53,22) gh, (51,23) co, (52,23) co, (53,23) g, (51,24) oc, (52,24) co, (53,24) g)
- units born: 1
- units moved: 2
...
## EMPIRE
- **score:** 106
- **gold:** 491 (net +15.4 = yield 18.4 − maint 3.0)
- **science:** 19.0/turn
- **culture:** 15.2/turn
- **faith:** 363 (+18.5/turn)
- **tourism:** 19.0/turn
- **military:** 135
- **techs / civics done:** 14 / 10
- **cities / units / pop:** 4 / 8 / 17
- **trade routes:** 1/1
- **explored land:** 442/1153 tiles
- **enabled victories:** VICTORY_TECHNOLOGY, VICTORY_CULTURE, VICTORY_RELIGIOUS, VICTORY_CONQUEST, VICTORY_SCORE

## RESEARCH / CIVIC
- **tech:** Engineering 112/200 (5t) — eureka:False [need: Build Ancient Walls.]
- **civic:** Theology 114/120 (1t) — inspiration:True

### TECHS AVAILABLE (up to 10, sorted by turns)
- Engineering  — 200sci (5t) — unlocks: Catapult, Aqueduct, Bath — boost: Build Ancient Walls.
- Celestial Navigation  — 120sci (7t) — unlocks: Lighthouse, Great Lighthouse, Harbor, Royal Navy Dockyard — boost: Improve 2 sea resources.
- Iron Working  — 120sci (7t) — unlocks: Swordsman, Legion, Ngao Mbeba — boost: Build an Iron Mine.
- Shipbuilding  — 200sci (11t) — unlocks: Quadrireme, Colossus — boost: Own 2 Galleys.
- Mathematics  — 200sci (11t) — unlocks: Petra — boost: Build 3 different specialty districts.
- Apprenticeship  — 300sci (16t) — unlocks: Man-At-Arms, Workshop, Industrial Zone, Hansa — boost: Build 3 Mines.
- Stirrups  — 390sci (21t) — unlocks: Knight, Mamluk — boost: Have the Feudalism civic.
- Military Engineering  — 390sci (21t) — unlocks: Military Engineer, Trebuchet, Armory, Reveals Niter — boost: Build an Aqueduct.
- Castles  — 390sci (21t) — unlocks: Medieval Walls, Alhambra — boost: Have a government with 6 policy slots.

### CIVICS AVAILABLE (up to 10, sorted by turns)
- Theology ★ — 120cul (1t) — unlocks: Scripture
- Military Training ★ — 120cul (4t) — unlocks: Raid, Veterancy
...
### TECH TREE (14/68 completed)
- **completed:** Pottery, Animal Husbandry, Mining, Sailing, Astrology, Irrigation, Archery, Writing, Masonry, Bronze Working, Wheel, Currency, Horseback Riding, Construction
- **current:** Engineering — 112/200sci (5t)
...
### CIVIC TREE (10/51 completed)
- **completed:** Code of Laws, Craftsmanship, Foreign Trade, Military Tradition, State Workforce, Early Empire, Mysticism, Games and Recreation, Political Philosophy, Drama and Poetry
- **current:** Theology — 114/120cul (1t)
...
## GREAT PEOPLE
- **GENERAL** 2pts (+1.2/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 32pts (+1.2/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 23pts (+2.3/turn) — next recruit cost 120 — candidate: Abu al-Qasim al-Zahrawi
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 4t (food+2.0) | hous 10 | amen 3/1 | happ 5 | border+19t
- yields: F8.0 P16.0 G10.5 S8.5 C6.2 Fa13.6
- **producing:** Builder (73/78, 1t)
...
- majority religion: RELIGION_TAOISM
    ...
    - tiles: 16 owned, 4 worked | terrain: 9 plains, 5 plains_hills, 1 grass, 1 grass_hills | features: 1 marsh, 1 forest | improvements: 3 farm, 2 sphinx, 2 mine, 1 camp
    - top production options: Builder (1t), Scout (2t), Warrior (3t), Trader (4t), Archer (4t), Spearman (5t), Battering Ram (5t), Horseman (5t), Ancient Walls (6t), Siege Tower (7t)
    - ...13 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 7 | grow 41t (food+8.0) | hous 7 | amen 2/3 | happ 3 | border+12t
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa2.9
- **producing:** Shrine (31/70, 6t)
- defense: str 22 | garrison 200/200 | walls 0/0
    ...
    - tiles: 12 owned, 8 worked | terrain: 8 grass, 2 plains, 1 plains_hills, 1 grass_hills | features: 2 jungle, 1 marsh | improvements: 2 pasture, 1 plantation, 1 farm
    - top production options: Scout (5t), Shrine (6t), Warrior (7t), Trader (10t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Builder (13t), Horseman (13t)
    - ...14 more options in JSON
### SHEDET @ (66,25)
- pop 5 | grow 6t (food+6.0) | hous 7 | amen 1/2 | happ 3 | border+1t
...
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - tiles: 9 owned, 6 worked | terrain: 6 grass, 1 coast, 1 plains, 1 grass_hills | features: 1 marsh, 1 forest | improvements: 2 quarry, 1 farm, 1 sphinx
    - top production options: Scout (4t), Warrior (6t), Archer (8t), Monument (8t), Trader (9t), Spearman (9t), Battering Ram (9t), Builder (11t), Horseman (11t), Ancient Walls (11t)
    - ...13 more options in JSON
### Luxis @ (64,22)
- pop 2 | grow 1t (food+2.0) | hous 5 | amen 1/0 | happ 5 | border+8t
- yields: F6.0 P4.2 G3.1 S2.5 C2.7 Fa1.0
- **producing:** nothing (0/0, -1t)
- defense: str 10 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - buildings in `CITY_CENTER`: Monument
    - tiles: 8 owned, 3 worked | terrain: 5 grass, 1 grass_mountain, 1 plains, 1 grass_hills | features: 1 forest, 1 jungle
    - top production options: Scout (7t), Warrior (9t), Archer (14t), Trader (15t), Spearman (15t), Battering Ram (15t), Granary (15t), Builder (19t), Horseman (19t), Ancient Walls (19t)
    - ...13 more options in JSON

## UNITS (8)
- **Scout** #196608 @(52,22) | hp100/100 | mv3/3 | cs10 rs0 xp16/45 <IDLE>
...
- **Builder** #1376260 @(66,25) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch3 <IDLE>
...
## DIPLOMACY
- **envoys:** 0 in hand | 44/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 123 mil 151 | met T27 | OB from them
### CITY-STATES MET
...
- **Amsterdam** (AMSTERDAM) — envoys sent 2 | suz: none | @(67,19) | met T54
...
## REVEALED MAP
_549 revealed, 108 currently visible, 1 natural wonders_
...
49,20 0|p|for||||||0|||
50,20 0|pm|||||||0||A4|
51,20 1|g|mar||||3||0||R/A3/F|
52,20 1|g||STONE|QUARRY||3||0||R/A2/F|
53,20 0|gm|||||||0||A4|
55,20 0|co|||||||0||L|
56,20 0|gh|||||||0||A1/F|
57,20 0|pm|||||||0||R/A4|
...
50,22 1|g|||||||0||R/A4/F|
51,22 1|gh|||||||0||R/A3/F|
52,22 1|ph|jun||||||0|0:SCOUT:100|A4|
...
66,25 1|p||||1|0|CITY_CENTER|1|0:WARRIOR:100;0:BUILDER:100|R/F|SHEDET
...
- per-query timing (s): meta=0.394, choices=0.358, cities=0.357, units=0.329, map=0.359, diplo=0.343, religion=0.327, notif=0.345
...
<!-- coach snapshot: schema=coach-snapshot/1.2 turn=99 generated_at=1785310074.1386194 failed_sections=none -->
