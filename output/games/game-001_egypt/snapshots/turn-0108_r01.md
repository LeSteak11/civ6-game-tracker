...
_Egypt (Cleopatra) — 200 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.4.0_

## CHANGES SINCE LAST SNAPSHOT
- turns elapsed: 1
- empire: gold: +12.199999999999932, faith: +22.200000000000045, military: -4, techs_done: +1, explored_land: +2
- newly revealed tiles: 2 (sample: (59,15) gh, (60,16) p)
- units moved: 3
...
- per-query timing (s): meta=0.368, choices=0.36, cities=0.377, units=0.343, map=0.359, diplo=0.358, religion=0.345, notif=0.344
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=108 generated_at=1785311837.337342 failed_sections=none -->
