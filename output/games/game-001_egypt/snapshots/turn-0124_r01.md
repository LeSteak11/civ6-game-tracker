# CIV6 COACH SNAPSHOT — turn 124
_Egypt (Cleopatra) — 200 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## EMPIRE
- **score:** 132
- **gold:** 510 (net +8.2 = yield 20.2 − maint 12.0)
- **science:** 23.8/turn
- **culture:** 19.1/turn
- **faith:** 906 (+26.0/turn)
- **tourism:** 20.0/turn
...
## RESEARCH / CIVIC
- **tech:** Shipbuilding 24/200 (8t) — eureka:False [need: Own 2 Galleys.]
- **civic:** Recorded History 49/175 (7t) — inspiration:False [need: Build 2 Campus districts.]
...
- Shipbuilding  — 200sci (8t) — unlocks: Quadrireme, Colossus — boost: Own 2 Galleys.
...
- Recorded History  — 175cul (7t) — unlocks: Natural Philosophy — inspiration: Build 2 Campus districts.
...
- **current:** Shipbuilding — 24/200sci (8t)
...
- **current:** Recorded History — 49/175cul (7t)
...
- **strategic:** 1 Iron
- **luxuries:** Ivory
- **owned bonus tiles:** 3× Rice (2/3 improved), 3× Stone (2/3 improved), 2× Bananas (1/2 improved), 2× Cattle, Fish (0/1 improved)
...
## GREAT PEOPLE
- **GENERAL** 52pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
- **ADMIRAL** 0pts (+0.0/turn) — next recruit cost 120 — candidate: Leif Erikson
- **ENGINEER** 1pts (+1.2/turn) — next recruit cost 120 — candidate: Bi Sheng
- **MERCHANT** 0pts (+0.0/turn) — next recruit cost 60 — candidate: Zhang Qian
- **PROPHET** 85pts (+3.5/turn) — next recruit cost 240 — candidate: Martin Luther
...
### Sais @ (62,26)
- pop 7 | grow 16t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+11t | growth -15%
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa11.4
- prod sources: tiles 6.0, other +0.7 (see JSON for all yields)
- **producing:** Granary (7/65, 9t)
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 27): Scout (5t), Granary (9t), Archer (10t), Spearman (10t), Battering Ram (10t), Trader (11t), Horseman (13t), Ancient Walls (13t), Water Mill (13t), Builder (15t)
    ...
    - unavailable (showing 6 of 44; full list + reasons in JSON):
        ...
        - Library — This building requires a Campus district.
### SHEDET @ (66,25)
- pop 7 | grow 13t (food+9.0) | hous 8 | amen 1/3 | happ Displeased | border+7t | growth -15%
- yields: F23.0 P7.6 G2.9 S4.7 C4.8 Fa1.0
- prod sources: tiles 7.0, other +0.6 (see JSON for all yields)
- **producing:** Water Mill (10/80, 10t)
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - tiles: 11 owned, 8 worked | terrain: 8 grass, 1 coast, 1 grass_hills, 1 plains | features: 1 marsh, 1 forest | improvements: 3 farm, 2 quarry, 1 sphinx
    - top production options (showing 10 of 25): Scout (4t), Archer (8t), Spearman (9t), Battering Ram (9t), Trader (10t), Water Mill (10t), Horseman (11t), Builder (13t), Siege Tower (14t), Catapult (16t)
    - ...15 more options in JSON
...
- defense: str 35 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 26): Builder (5t), Scout (5t), Archer (10t), Spearman (11t), Battering Ram (11t), Trader (12t), Horseman (14t), Ancient Walls (14t), Water Mill (14t), Siege Tower (17t)
...
## UNITS (9)
- **Builder** #1703936 @(67,24) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch2 <IDLE>
- **Scout** #1835009 @(67,22) | hp100/100 | mv3/3 | cs10 rs0 xp0/15
...
## DIPLOMACY
- **envoys:** 1 in hand | 31/100 pts (+5.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 162 mil 153 | met T27 | OB from them
...
## REVEALED MAP
_626 revealed, 152 currently visible, 1 natural wonders_
...
66,13 1|g|||||||0||R/A-1/F|
67,13 1|g||TOBACCO|||||0|10:ARCHER:100|R/A1/F|
68,13 0|g|||||||0||R/A4/F|
...
62,16 1|g|mar||||||0||A-2|
63,16 1|d||||1|||0||A-2|
64,16 1|d|||||||0|11:SWORDSMAN:100|A-1|
65,16 1|dh|||||||0||A-2|
66,16 1|d||||1|||0||A-1|
67,16 1|d|||||||0|||
68,16 1|dh|||||||0||F|
...
63,18 1|g|for||||||0|7:WARRIOR:100|A1|
64,18 1|g|for||||||0||A2|
65,18 1|g|||||||0|||
...
67,24 1|g||STONE||1|0||0|0:BUILDER:100|R/A4/F|
68,24 1|co|||||||0|||
69,24 1|oc|||||||0|||
47,25 0|oc|||||||0|||
48,25 0|oc|||||||0|||
...
- per-query timing (s): meta=0.37, choices=0.358, cities=0.395, units=0.346, map=0.363, diplo=0.358, religion=0.345, notif=0.332
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=124 generated_at=1785314554.7719092 failed_sections=none counts: cities=4 units=9 tiles=626 majors=1 city_states=4 gossip=19 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=36817 -->
