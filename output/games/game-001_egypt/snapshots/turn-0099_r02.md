...
_Egypt (Cleopatra) — 425 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.3 coach 1.3.0_
...
- **producing:** Ancient Walls (0/80, 11t)
- defense: str 20 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (66,25)
    - buildings in `CITY_CENTER`: Granary
    - tiles: 9 owned, 6 worked | terrain: 6 grass, 1 coast, 1 plains, 1 grass_hills | features: 1 forest, 1 marsh | improvements: 2 quarry, 1 farm, 1 sphinx
...
- **producing:** Granary (0/65, 15t)
- defense: str 10 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - buildings in `CITY_CENTER`: Monument
    - tiles: 8 owned, 3 worked | terrain: 5 grass, 1 grass_mountain, 1 plains, 1 grass_hills | features: 1 jungle, 1 forest
...
## UNITS (8)
- **Scout** #196608 @(52,20) | hp100/100 | mv0/3 | cs10 rs0 xp16/45
...
- **Builder** #1376260 @(67,24) | hp100/100 | mv1/2 | cs0 rs0 xp0/15 ch3
...
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 123 mil 151 | met T27 | OB from them
    - public: techs 18 | civics 11 | tourism 4
    - known cities (5): Uruk★?, Lagash?, Rio de Janeiro p4, Adab?, Recife?
...
## REVEALED MAP
_550 revealed, 110 currently visible, 1 natural wonders_
...
52,20 1|g||STONE|QUARRY||3||0|0:SCOUT:100|R/A2/F|
53,20 1|gm|||||||0||A4|
55,20 0|co|||||||0||L|
56,20 0|gh|||||||0||A1/F|
57,20 0|pm|||||||0||R/A4|
...
- per-query timing (s): meta=0.367, choices=0.358, cities=0.358, units=0.343, map=0.361, diplo=0.344, religion=0.345, notif=0.346
...
<!-- coach snapshot: schema=coach-snapshot/1.3 turn=99 generated_at=1785310274.8096821 failed_sections=none -->
