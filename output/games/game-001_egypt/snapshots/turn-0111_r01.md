# CIV6 COACH SNAPSHOT — turn 111
_Egypt (Cleopatra) — 125 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.5.0_
...
## EMPIRE
- **score:** 117
- **gold:** 567 (net +10.2 = yield 17.2 − maint 7.0)
- **science:** 21.0/turn
- **culture:** 17.9/turn
- **faith:** 615 (+22.2/turn)
- **tourism:** 19.0/turn
...
## RESEARCH / CIVIC
- **tech:** Apprenticeship 216/300 (4t) — eureka:True
- **civic:** Defensive Tactics 124/175 (3t) — inspiration:False [need: Be the target of a Declaration of War.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Apprenticeship ★ — 300sci (4t) — unlocks: Man-At-Arms, Workshop, Industrial Zone, Hansa
...
- Defensive Tactics  — 175cul (3t) — unlocks: Bastions, Limes — inspiration: Be the target of a Declaration of War.
...
- **current:** Apprenticeship — 216/300sci (4t)
...
- **current:** Defensive Tactics — 124/175cul (3t)
...
## GREAT PEOPLE
- **GENERAL** 21pts (+2.3/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 53pts (+2.3/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 51pts (+2.3/turn) — next recruit cost 120 — candidate: Omar Khayyam
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 4 | grow 32t (food+1.0) | hous 11 | amen 3/1 | happ Happy | border+6t | growth +10%
- yields: F9.0 P15.1 G9.4 S9.2 C6.5 Fa12.6
- prod sources: tiles 9.0, bldgs 4, other +2.1 (see JSON for all yields)
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options: Scout (2t), Trader (4t), Archer (4t), Spearman (4t), Battering Ram (4t), Horseman (5t), Builder (6t), Swordsman (6t), Siege Tower (6t), Catapult (7t)
    - ...13 more options in JSON
### Sais @ (62,26)
- pop 7 | grow 29t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+24t | growth -15%
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa7.6
- prod sources: tiles 6.0, other +0.7 (see JSON for all yields)
- **producing:** Temple (41/120, 12t)
- defense: str 27 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (5t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Trader (11t), Temple (12t), Horseman (13t), Ancient Walls (13t), Water Mill (13t)
    - ...17 more options in JSON
### SHEDET @ (66,25)
- pop 6 | grow 5t (food+7.0) | hous 8 | amen 1/2 | happ Displeased | border+5t | growth -15%
- yields: F19.0 P8.6 G2.9 S4.0 C4.6 Fa1.0
- prod sources: tiles 8.0, other +0.6 (see JSON for all yields)
- **producing:** Builder (15/90, 9t)
- defense: str 28 | garrison 200/200 | walls 100/100
    ...
    - tiles: 10 owned, 7 worked | terrain: 7 grass, 1 coast, 1 plains, 1 grass_hills | features: 1 marsh, 1 forest | improvements: 3 quarry, 2 farm, 1 sphinx
    - top production options: Scout (4t), Trader (8t), Archer (8t), Spearman (8t), Battering Ram (8t), Builder (9t), Horseman (10t), Water Mill (10t), Swordsman (11t), Siege Tower (12t)
    - ...14 more options in JSON
### Luxis @ (64,22)
- pop 3 | grow 6t (food+2.0) | hous 5 | amen 1/1 | happ Content | border+7t
- yields: F8.0 P5.0 G3.0 S3.1 C2.9 Fa1.0
- prod sources: tiles 4.0, other +1.0 (see JSON for all yields)
- **producing:** Granary (63/65, 1t)
- defense: str 25 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - buildings in `CITY_CENTER`: Monument
    - tiles: 9 owned, 4 worked | terrain: 6 grass, 1 grass_mountain, 1 plains, 1 grass_hills | features: 1 forest, 1 jungle
    - top production options: Granary (1t), Scout (6t), Archer (12t), Spearman (13t), Battering Ram (13t), Trader (14t), Horseman (16t), Ancient Walls (16t), Water Mill (16t), Swordsman (18t)
    - ...16 more options in JSON

## UNITS (8)
- **Scout** #196608 @(62,16) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
- **Builder** #1572865 @(66,29) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch3 <IDLE>
...
- **Swordsman** #1507336 @(66,29) | hp97/100 | mv3/3 | cs35 rs0 xp15/15 fort:1

## DIPLOMACY
- **envoys:** 0 in hand | 80/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 143 mil 167 | met T27 | OB from them
    - public: techs 21 | civics 12 | tourism 4
...
62,16 1|g|mar||||||0|0:SCOUT:100|A-2|
63,16 1|d||||1|||0||A-2|
64,16 1|d|||||||0||A-1|
65,16 0|dh|||||||0||A-2|
66,16 1|d||||1|||0||A-1|
...
64,18 0|g|for||||||0||A2|
65,18 1|g|||||||0|||
66,18 1|g||STONE|||||0|10:WARRIOR:100|A-1|
...
66,29 1|ph||||1|0|CITY_CENTER|1|0:GREAT_GENERAL:100;0:SWORDSMAN:97;0:BUILDER:100|R/F|Râ-Kedet
...
- per-query timing (s): meta=0.371, choices=0.36, cities=0.39, units=0.343, map=0.378, diplo=0.358, religion=0.346, notif=0.343
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=111 generated_at=1785312345.6900835 failed_sections=none -->
