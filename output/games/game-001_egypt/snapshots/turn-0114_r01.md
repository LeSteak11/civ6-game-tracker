# CIV6 COACH SNAPSHOT — turn 114
_Egypt (Cleopatra) — 50 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.5.0_
...
## EMPIRE
- **score:** 117
- **gold:** 598 (net +10.2 = yield 17.2 − maint 7.0)
- **science:** 21.0/turn
- **culture:** 17.9/turn
- **faith:** 681 (+22.2/turn)
- **tourism:** 19.0/turn
- **military:** 159
- **techs / civics done:** 16 / 13
...
## RESEARCH / CIVIC
- **tech:** Apprenticeship 279/300 (1t) — eureka:True
- **civic:** none 0/0 (-1t) — inspiration:False

### TECHS AVAILABLE (up to 10, sorted by turns)
- Apprenticeship ★ — 300sci (1t) — unlocks: Man-At-Arms, Workshop, Industrial Zone, Hansa
...
- Feudalism ★ — 275cul (8t) — unlocks: Feudal Contract, Serfdom
...
- **current:** Apprenticeship — 279/300sci (1t)
...
## GREAT PEOPLE
- **GENERAL** 28pts (+2.3/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 60pts (+2.3/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 58pts (+2.3/turn) — next recruit cost 120 — candidate: Omar Khayyam
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options: Spearman (1t), Scout (2t), Archer (3t), Trader (4t), Battering Ram (4t), Horseman (4t), Builder (5t), Swordsman (5t), Siege Tower (5t), Catapult (6t)
    - ...13 more options in JSON
    - trade → Sais (domestic): Food +2, Production +1
### Sais @ (62,26)
- pop 7 | grow 26t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+21t | growth -15%
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa7.6
- prod sources: tiles 6.0, other +0.7 (see JSON for all yields)
- **producing:** Temple (61/120, 9t)
- defense: str 27 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (5t), Temple (9t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Trader (11t), Horseman (13t), Ancient Walls (13t), Water Mill (13t)
    - ...17 more options in JSON
### SHEDET @ (66,25)
- pop 6 | grow 2t (food+7.0) | hous 8 | amen 1/2 | happ Displeased | border+2t | growth -15%
- yields: F19.0 P8.6 G2.9 S4.0 C4.6 Fa1.0
- prod sources: tiles 8.0, other +0.6 (see JSON for all yields)
- **producing:** Builder (40/90, 6t)
- defense: str 28 | garrison 200/200 | walls 100/100
    ...
    - top production options: Scout (4t), Builder (6t), Archer (8t), Spearman (8t), Battering Ram (8t), Trader (9t), Horseman (10t), Water Mill (10t), Swordsman (11t), Siege Tower (12t)
    - ...14 more options in JSON
### Luxis @ (64,22)
- pop 3 | grow 1t (food+3.0) | hous 7 | amen 1/1 | happ Content | border+4t
- yields: F9.0 P5.0 G3.0 S3.1 C2.9 Fa1.0
- prod sources: tiles 4.0, other +1.0 (see JSON for all yields)
- **producing:** Builder (13/90, 16t)
- defense: str 25 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - buildings in `CITY_CENTER`: Monument, Granary
    - tiles: 9 owned, 4 worked | terrain: 6 grass, 1 grass_mountain, 1 grass_hills, 1 plains | features: 1 forest, 1 jungle
    - top production options: Scout (6t), Archer (12t), Spearman (13t), Battering Ram (13t), Trader (14t), Builder (16t), Horseman (16t), Ancient Walls (16t), Water Mill (16t), Swordsman (18t)
    - ...15 more options in JSON

## UNITS (8)
- **Scout** #196608 @(65,24) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
- **Builder** #1572865 @(67,31) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch2
...
## DIPLOMACY
- **envoys:** 0 in hand | 89/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 145 mil 171 | met T27 | OB from them
...
- **units visible (1):** Scout @(67,32) hp100/100
...
- `NOTIFICATION_CIVIC_DISCOVERED`: Discovered Defensive Tactics
- `NOTIFICATION_CHOOSE_CIVIC` [BLOCKS: ENDTURN_BLOCKING_CIVIC]: Choose a Civic

## REVEALED MAP
_617 revealed, 143 currently visible, 1 natural wonders_
...
64,16 0|d|||||||0||A-1|
65,16 0|dh|||||||0||A-2|
66,16 1|d||||1|||0|10:WARRIOR:100|A-1|
67,16 1|d|||||||0|||
68,16 1|dh|||||||0||F|
69,16 1|d|||||||0||A2/F|
...
65,20 1|g|||||||0|11:SWORDSMAN:100|A2|
...
64,24 1|g|||||||0||A3|
65,24 1|g||RICE||1|0||0|0:SCOUT:100|R/A3/F|
...
65,31 1|co|||||||0|||
66,31 1|p|||||0||0|||
67,31 1|p|||FARM||0||0|0:BUILDER:100|A1|
68,31 1|p|||||||0||A5|
69,31 1|co|||||||0|||
70,31 0|co||FISH|||||0|||
63,32 0|co||CRABS|||||0|||
...
- per-query timing (s): meta=0.374, choices=0.359, cities=0.374, units=0.345, map=0.361, diplo=0.355, religion=0.329, notif=0.343
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=114 generated_at=1785313153.5185142 failed_sections=none -->
