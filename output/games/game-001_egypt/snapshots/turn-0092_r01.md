# CIV6 COACH SNAPSHOT — turn 92
_Egypt (Cleopatra) — 600 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.2 coach 1.2.1_
...
## EMPIRE
- **score:** 94
- **gold:** 395 (net +13.6 = yield 15.6 − maint 2.0)
- **science:** 18.3/turn
- **culture:** 12.8/turn
- **faith:** 249 (+14.6/turn)
- **tourism:** 19.0/turn
...
## RESEARCH / CIVIC
- **tech:** Construction 180/200 (2t) — eureka:False [need: Build a Water Mill.]
- **civic:** Drama and Poetry 73/110 (3t) — inspiration:True

### TECHS AVAILABLE (up to 10, sorted by turns)
- Construction  — 200sci (2t) — unlocks: Siege Tower, Terracotta Army — boost: Build a Water Mill.
...
- Drama and Poetry ★ — 110cul (3t) — unlocks: Literary Tradition
...
- **current:** Construction — 180/200sci (2t)
...
- **current:** Drama and Poetry — 73/110cul (3t)
...
## GREAT PEOPLE
- **GENERAL** 54pts (+1.2/turn) — next recruit cost 60 — candidate: Sun Tzu
...
- **SCIENTIST** 7pts (+2.3/turn) — next recruit cost 120 — candidate: Abu al-Qasim al-Zahrawi
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 19t (food+1.0) | hous 10 | amen 3/1 | happ 5 | border+7t
- yields: F7.0 P12.8 G10.5 S8.5 C6.2 Fa13.6
- **producing:** Water Mill (51/80, 3t)
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options: Scout (3t), Warrior (3t), Water Mill (3t), Trader (5t), Archer (5t), Spearman (5t), Battering Ram (5t), Builder (6t), Horseman (6t), Ancient Walls (7t)
    - ...11 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 6 | grow 2t (food+8.0) | hous 7 | amen 1/2 | happ 3 | border+1t
- yields: F20.0 P6.7 G1.9 S4.0 C3.6 Fa0.0
- **producing:** Holy Site (115/131, 3t)
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - top production options: Holy Site (3t), Scout (5t), Warrior (7t), Trader (10t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Builder (12t), Horseman (13t)
    - ...10 more options in JSON
### SHEDET @ (66,25)
- pop 5 | grow 52t (food+5.0) | hous 5 | amen 1/2 | happ 3 | border+8t
- yields: F15.0 P7.6 G0.0 S3.3 C2.4 Fa1.0
- **producing:** Granary (48/65, 3t)
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - top production options: Granary (3t), Scout (4t), Builder (5t), Warrior (6t), Archer (8t), Monument (8t), Trader (9t), Spearman (9t), Battering Ram (9t), Horseman (11t)
    - ...11 more options in JSON
### Luxis @ (64,22)
- pop 2 | grow 8t (food+2.0) | hous 5 | amen 1/0 | happ 5 | border+10t
- yields: F6.0 P4.2 G3.1 S2.5 C0.6 Fa0.0
- **producing:** Monument (34/60, 7t)
- defense: str 10 | garrison 200/200 | walls 0/0
    ...
    - top production options: Monument (7t), Scout (8t), Warrior (10t), Trader (15t), Archer (15t), Spearman (16t), Battering Ram (16t), Granary (16t), Builder (19t), Horseman (20t)
    - ...11 more options in JSON

## UNITS (6)
- **Scout** #196608 @(49,21) | hp78/100 | mv3/3 | cs10 rs0 xp16/45 fort:2
- **Warrior** #131073 @(66,29) | hp100/100 | mv2/2 | cs20 rs0 xp7/15 fort:2
- **Trader** #786434 @(65,24) | hp100/100 | mv2/2 | cs0 rs0 xp0/15
...
## DIPLOMACY
- **envoys:** 0 in hand | 23/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 109 mil 127 | met T27 | OB from them
### CITY-STATES MET
...
- **units visible (1):** Galley @(61,28) hp100/100
...
## REVEALED MAP
_529 revealed, 101 currently visible, 1 natural wonders_
...
- per-query timing (s): meta=0.382, choices=0.36, cities=0.359, units=0.344, map=0.36, diplo=0.373, religion=0.347, notif=0.33
...
<!-- coach snapshot: schema=coach-snapshot/1.2 turn=92 generated_at=1785308999.002322 failed_sections=none -->
