# CIV6 COACH SNAPSHOT — turn 122
_Egypt (Cleopatra) — 150 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## EMPIRE
- **score:** 124
- **gold:** 490 (net +8.2 = yield 17.2 − maint 9.0)
- **science:** 23.1/turn
- **culture:** 18.8/turn
- **faith:** 858 (+22.2/turn)
- **tourism:** 20.0/turn
- **military:** 175
- **techs / civics done:** 17 / 14
- **cities / units / pop:** 4 / 9 / 23
- **trade routes:** 1/1
...
## RESEARCH / CIVIC
- **tech:** Mathematics 157/200 (2t) — eureka:False [need: Build 3 different specialty districts.]
- **civic:** none 0/0 (-1t) — inspiration:False

### TECHS AVAILABLE (up to 10, sorted by turns)
- Mathematics  — 200sci (2t) — unlocks: Petra — boost: Build 3 different specialty districts.
...
- Shipbuilding  — 200sci (9t) — unlocks: Quadrireme, Colossus — boost: Own 2 Galleys.
...
- Recorded History  — 175cul (9t) — unlocks: Natural Philosophy — inspiration: Build 2 Campus districts.
- Naval Tradition  — 200cul (11t) — unlocks: Naval Infrastructure, Navigation — inspiration: Kill a unit with a Quadrireme.
- Mercenaries  — 290cul (15t) — unlocks: Sack, Professional Army, Trade Confederation — inspiration: Have 8 land combat units in your military.
- Medieval Faires  — 385cul (20t) — unlocks: Merchant Confederation, Aesthetics, Medina Quarter — inspiration: Maintain 4 Trade Routes.

### TECH TREE (17/68 completed)
- **completed:** Pottery, Animal Husbandry, Mining, Sailing, Astrology, Irrigation, Archery, Writing, Masonry, Bronze Working, Wheel, Currency, Horseback Riding, Iron Working, Construction, Engineering, Apprenticeship
- **current:** Mathematics — 157/200sci (2t)
...
## GREAT PEOPLE
- **GENERAL** 47pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 79pts (+2.4/turn) — next recruit cost 240 — candidate: Martin Luther
- **SCIENTIST** 77pts (+2.4/turn) — next recruit cost 120 — candidate: Hildegard of Bingen
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 5 | grow 1t (food+3.0) | hous 12 | amen 3/2 | happ Happy | border+16t | growth +10%
- yields: F13.0 P21.8 G9.4 S10.0 C6.8 Fa12.6
- prod sources: tiles 14.0, bldgs 4, adj 1, trade 1, other +1.8 (see JSON for all yields)
- **producing:** Industrial Zone (163/175, 1t)
- defense: str 53 | garrison 200/200 | walls 100/100
- majority religion: RELIGION_TAOISM
    ...
    - tiles: 17 owned, 6 worked | terrain: 9 plains, 5 plains_hills, 1 grass, 1 coast, 1 grass_hills | improvements: 5 farm, 3 mine, 2 sphinx, 1 camp
    - top production options (showing 10 of 23): Industrial Zone (1t), Scout (2t), Archer (3t), Spearman (3t), Battering Ram (3t), Builder (4t), Trader (4t), Horseman (4t), Siege Tower (5t), Catapult (6t)
...
### Sais @ (62,26)
- pop 7 | grow 18t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+13t | growth -15%
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa7.6
- prod sources: tiles 6.0, other +0.7 (see JSON for all yields)
- **producing:** Temple (114/120, 1t)
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - tiles: 13 owned, 8 worked | terrain: 9 grass, 2 plains, 1 grass_hills, 1 plains_hills | features: 2 jungle, 1 marsh | improvements: 2 pasture, 1 farm, 1 plantation
    - top production options (showing 10 of 27): Temple (1t), Scout (5t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Trader (11t), Horseman (13t), Ancient Walls (13t), Water Mill (13t)
    ...
    - unavailable (showing 6 of 44; full list + reasons in JSON):
        ...
        - Library — This building requires a Campus district.
### SHEDET @ (66,25)
- pop 7 | grow 15t (food+9.0) | hous 8 | amen 1/3 | happ Displeased | border+9t | growth -15%
- yields: F23.0 P8.6 G2.9 S4.7 C4.8 Fa1.0
- prod sources: tiles 8.0, other +0.6 (see JSON for all yields)
- **producing:** Scout (23/30, 1t)
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - tiles: 11 owned, 8 worked | terrain: 8 grass, 1 plains, 1 coast, 1 grass_hills | features: 1 forest, 1 marsh | improvements: 3 farm, 3 quarry, 1 sphinx
    - top production options (showing 10 of 24): Scout (1t), Archer (8t), Spearman (8t), Battering Ram (8t), Trader (9t), Horseman (10t), Water Mill (10t), Builder (12t), Siege Tower (12t), Catapult (15t)
    ...
    - unavailable (showing 6 of 46; full list + reasons in JSON):
        ...
        - Barracks — This building requires an Encampment district.
### Luxis @ (64,22)
- pop 4 | grow 7t (food+3.0) | hous 7 | amen 1/1 | happ Content | border+12t
- yields: F11.0 P6.0 G3.0 S3.8 C3.2 Fa1.0
- prod sources: tiles 5.0, other +1.0 (see JSON for all yields)
- **producing:** Builder (57/94, 7t)
- defense: str 35 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - buildings in `CITY_CENTER`: Monument, Granary
    - tiles: 10 owned, 5 worked | terrain: 7 grass, 1 grass_mountain, 1 plains, 1 grass_hills | features: 2 forest, 1 jungle
    - top production options (showing 10 of 25): Scout (5t), Builder (7t), Archer (10t), Spearman (11t), Battering Ram (11t), Trader (12t), Horseman (14t), Ancient Walls (14t), Water Mill (14t), Siege Tower (17t)
...
## UNITS (9)
- **Builder** #1703936 @(65,24) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch2 <IDLE>
- **Builder** #1572865 @(67,27) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch1 <IDLE>
...
- **Archer** #1048582 @(66,31) | hp100/100 | mv2/2 | cs15 rs25 xp25/45 fort:2 <IDLE>
- **Warrior** #983047 @(66,25) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 fort:2
- **Man-At-Arms** #1769481 @(66,29) | hp100/100 | mv3/3 | cs45 rs0 xp15/15

## DIPLOMACY
- **envoys:** 1 in hand | 21/100 pts (+5.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 162 mil 147 | met T27 | OB from them
...
- Stockholm (city-state): 2 unit(s) — WARRIOR, ARCHER
- Kabul (city-state): 2 unit(s) — ARCHER, WARRIOR

## BARBARIANS (only what we can currently see)
- **units visible (1):** Scout @(66,33) hp100/100
...
- `NOTIFICATION_CIVIC_DISCOVERED`: Discovered Feudalism
...
## REVEALED MAP
_626 revealed, 161 currently visible, 1 natural wonders_
...
66,13 1|g|||||||0||R/A-1/F|
67,13 1|g||TOBACCO|||||0|10:ARCHER:84|R/A1/F|
68,13 0|g|||||||0||R/A4/F|
...
60,14 1|g|||||3||0|||
61,14 1|g|||||||0|||
62,14 1|dh|||||||0|11:SWORDSMAN:100|A1|
63,14 1|dm|||||||0||A4|
...
62,16 1|g|mar||||||0|7:WARRIOR:100|A-2|
63,16 1|d||||1|||0||A-2|
64,16 0|d|||||||0||A-1|
65,16 0|dh|||||||0||A-2|
66,16 1|d||||1|||0||A-1|
...
67,18 1|g|||FARM|1|11||0|11:SWORDSMAN:100||
...
64,24 1|g|||||||0||A3|
65,24 1|g||RICE|FARM|1|0||0|0:BUILDER:100|R/A3/F|
...
67,27 1|g|||||0||0|0:BUILDER:100|R/A5/F|
68,27 1|co|||||||0|||
69,27 1|oc|||||||0|||
52,28 0|co|||||||0|||
53,28 0|co||CRABS|||||0|||
...
64,31 1|co|||||||0|||
65,31 1|co|||||0||0|||
66,31 1|p|||||0|INDUSTRIAL_ZONE|0|0:ARCHER:100||
...
64,33 0|oc|||||||0|||
65,33 1|co|||||||0|||
66,33 1|g|mar||||||0|63:SCOUT:100|A1|
...
- per-query timing (s): meta=0.38, choices=0.363, cities=0.394, units=0.327, map=0.361, diplo=0.36, religion=0.33, notif=0.344
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=122 generated_at=1785314174.324933 failed_sections=none counts: cities=4 units=9 tiles=626 majors=1 city_states=4 gossip=19 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=37153 -->
