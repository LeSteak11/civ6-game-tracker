# CIV6 COACH SNAPSHOT — turn 137
_Egypt (Cleopatra) — 520 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## EMPIRE
- **score:** 137
- **gold:** 544 (net +24.0 = yield 37.0 − maint 13.0)
- **science:** 25.4/turn
- **culture:** 20.8/turn
- **faith:** 1259 (+27.5/turn)
- **tourism:** 20.0/turn
- **military:** 189
- **techs / civics done:** 20 / 15
- **cities / units / pop:** 4 / 10 / 26
- **trade routes:** 1/1
...
- **civic:** Civil Service 137/275 (7t) — inspiration:False [need: Grow a city to 10 population.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Stirrups ★ — 390sci (7t) — unlocks: Knight, Mamluk
- Military Tactics  — 300sci (11t) — unlocks: Berserker, Pikeman, Huey Teocalli — boost: Kill a unit with a Spearman.
- Machinery  — 300sci (11t) — unlocks: Crossbowman, Crouching Tiger, Lumber Mill — boost: Own 3 Archers.
...
- Civil Service  — 275cul (7t) — unlocks: Retainers, Meritocracy — inspiration: Grow a city to 10 population.
...
- **current:** Civil Service — 137/275cul (7t)
...
## GREAT PEOPLE
- **GENERAL** 82pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
- **ADMIRAL** 0pts (+0.0/turn) — next recruit cost 120 — candidate: Leif Erikson
- **ENGINEER** 25pts (+2.4/turn) — next recruit cost 120 — candidate: Bi Sheng
- **MERCHANT** 0pts (+0.0/turn) — next recruit cost 60 — candidate: Zhang Qian
- **PROPHET** 131pts (+3.6/turn) — next recruit cost 240 — candidate: Martin Luther
- **SCIENTIST** 93pts (+2.4/turn) — next recruit cost 240 — candidate: Emilie du Chatelet
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options (showing 10 of 27): Archer (1t), Scout (2t), Trader (3t), Spearman (3t), Battering Ram (3t), Horseman (3t), Builder (4t), Siege Tower (4t), Catapult (5t), Maryannu Chariot Archer (5t)
...
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 29): Scout (5t), Water Mill (7t), Archer (9t), Spearman (10t), Battering Ram (10t), Trader (11t), Horseman (12t), Ancient Walls (12t), Builder (15t), Siege Tower (15t)
    - ...19 more options in JSON
...
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - top production options (showing 10 of 27): Archer (2t), Scout (4t), Spearman (7t), Battering Ram (7t), Trader (8t), Horseman (9t), Builder (11t), Siege Tower (11t), Catapult (13t), Maryannu Chariot Archer (13t)
    - ...17 more options in JSON
...
- defense: str 35 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 29): Water Mill (3t), Scout (4t), Archer (7t), Spearman (8t), Battering Ram (8t), Trader (9t), Horseman (9t), Ancient Walls (9t), Builder (11t), Siege Tower (12t)
    - ...19 more options in JSON
    - unavailable (showing 6 of 49; full list + reasons in JSON):
        - Great Library — Requires Library [reconstructed: BuildingPrereqs]
        - Stonehenge — blocked (reason not exposed by engine)
...
## UNITS (10)
- **Builder** #1900544 @(63,23) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch2 <IDLE>
- **Scout** #1835009 @(73,10) | hp88/100 | mv3/3 | cs10 rs0 xp15/15 fort:2
...
- **Settler** #1966088 @(66,30) | hp100/100 | mv2/2 | cs0 rs0 xp0/15
- **Man-At-Arms** #1769481 @(66,30) | hp100/100 | mv3/3 | cs45 rs0 xp15/45
...
- **units visible (1):** Galley @(1,10) hp100/100
...
- `NOTIFICATION_TECH_DISCOVERED`: Discovered Celestial Navigation
...
## REVEALED MAP
_657 revealed, 196 currently visible, 2 natural wonders_
...
54,21 1|co|||||||0||L|
55,21 1|g||STONE|||||0|8:WARRIOR:100|A1/F|
...
61,23 1|gm|||||||0||A4|
62,23 1|gm|||||||0||A4|
63,23 1|gh||IRON|MINE||0||0|0:BUILDER:100|A2|
64,23 1|g||||1|0||0||R/A2/F|
...
66,30 1|p|||FARM||0||0|0:SETTLER:100;0:MAN_AT_ARMS:100|R/F|
...
- per-query timing (s): meta=0.364, choices=0.375, cities=0.391, units=0.34, map=0.361, diplo=0.356, religion=0.342, notif=0.331
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=137 generated_at=1785315948.964274 failed_sections=none counts: cities=4 units=10 tiles=657 majors=1 city_states=4 gossip=22 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=38006 -->
