# CIV6 COACH SNAPSHOT — turn 133
_Egypt (Cleopatra) — 425 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## EMPIRE
- **score:** 137
- **gold:** 479 (net +9.3 = yield 22.3 − maint 13.0)
- **science:** 24.8/turn
- **culture:** 20.5/turn
- **faith:** 1149 (+27.5/turn)
- **tourism:** 20.0/turn
- **military:** 179
...
## RESEARCH / CIVIC
- **tech:** Celestial Navigation 41/120 (4t) — eureka:False [need: Improve 2 sea resources.]
- **civic:** Civil Service 54/275 (11t) — inspiration:False [need: Grow a city to 10 population.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Celestial Navigation  — 120sci (4t) — unlocks: Lighthouse, Great Lighthouse, Harbor, Royal Navy Dockyard — boost: Improve 2 sea resources.
...
- Civil Service  — 275cul (11t) — unlocks: Retainers, Meritocracy — inspiration: Grow a city to 10 population.
...
- **current:** Celestial Navigation — 41/120sci (4t)
...
- **current:** Civil Service — 54/275cul (11t)
...
## GREAT PEOPLE
- **GENERAL** 73pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
- **ADMIRAL** 0pts (+0.0/turn) — next recruit cost 120 — candidate: Leif Erikson
- **ENGINEER** 15pts (+2.4/turn) — next recruit cost 120 — candidate: Bi Sheng
- **MERCHANT** 0pts (+0.0/turn) — next recruit cost 60 — candidate: Zhang Qian
- **PROPHET** 117pts (+3.5/turn) — next recruit cost 240 — candidate: Martin Luther
- **SCIENTIST** 84pts (+2.4/turn) — next recruit cost 240 — candidate: Emilie du Chatelet
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options (showing 10 of 25): Scout (1t), Archer (2t), Settler (3t), Trader (3t), Spearman (3t), Battering Ram (3t), Horseman (3t), Builder (4t), Catapult (4t), Siege Tower (4t)
...
### Sais @ (62,26)
- pop 7 | grow 1t (food+9.0) | hous 9 | amen 3/3 | happ Content | border+2t
- yields: F23.0 P7.0 G2.0 S4.9 C4.1 Fa12.0
...
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 27): Scout (4t), Archer (9t), Spearman (9t), Battering Ram (9t), Trader (11t), Horseman (11t), Ancient Walls (11t), Water Mill (11t), Builder (14t), Siege Tower (14t)
...
### SHEDET @ (66,25)
- pop 7 | grow 4t (food+11.0) | hous 8 | amen 2/3 | happ Displeased | border+13t | growth -15%
- yields: F25.0 P9.5 G2.9 S4.7 C5.8 Fa1.9
...
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - top production options (showing 10 of 25): Scout (3t), Archer (6t), Spearman (7t), Battering Ram (7t), Trader (8t), Horseman (8t), Builder (10t), Siege Tower (10t), Catapult (12t), Maryannu Chariot Archer (12t)
    - ...15 more options in JSON
...
- defense: str 35 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 27): Scout (5t), Water Mill (9t), Archer (10t), Spearman (11t), Battering Ram (11t), Trader (13t), Horseman (14t), Ancient Walls (14t), Builder (17t), Siege Tower (17t)
    - ...17 more options in JSON
    - unavailable (showing 6 of 48; full list + reasons in JSON):
        - Great Library — Requires Library [reconstructed: BuildingPrereqs]
        - Stonehenge — blocked (reason not exposed by engine)
...
## UNITS (9)
- **Builder** #1900544 @(63,21) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch4
- **Scout** #1835009 @(73,10) | hp48/100 | mv3/3 | cs10 rs0 xp15/15
...
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 175 mil 166 | met T27 | OB from them
    - public: techs 25 | civics 15 | tourism 9
...
- **units visible (1):** Scout @(53,23) hp100/100
...
## REVEALED MAP
_657 revealed, 202 currently visible, 2 natural wonders_
...
63,17 0|d|||||||0|||
64,17 1|p|jun||||||0|||
65,17 1|p|jun||||||0|7:ARCHER:100|A-1|
66,17 1|d||||1|||0||A-1|
...
63,19 1|gm|||||||0||A4|
64,19 1|g|for|DYES|||||0|7:WARRIOR:100|A3|
65,19 1|g|||||||0||A1|
66,19 1|g|||FARM||11||0|||
...
- per-query timing (s): meta=0.383, choices=0.36, cities=0.391, units=0.345, map=0.377, diplo=0.36, religion=0.348, notif=0.345
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=133 generated_at=1785315399.910624 failed_sections=none counts: cities=4 units=9 tiles=657 majors=1 city_states=4 gossip=21 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=38170 -->
