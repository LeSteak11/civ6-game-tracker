# CIV6 COACH SNAPSHOT — turn 105
_Egypt (Cleopatra) — 275 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.4.0_
...
## RESEARCH / CIVIC
- **tech:** Iron Working 60/120 (3t) — eureka:False [need: Build an Iron Mine.]
- **civic:** Defensive Tactics 27/175 (10t) — inspiration:False [need: Be the target of a Declaration of War.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Iron Working  — 120sci (3t) — unlocks: Swordsman, Legion, Ngao Mbeba — boost: Build an Iron Mine.
...
- Apprenticeship ★ — 300sci (8t) — unlocks: Man-At-Arms, Workshop, Industrial Zone, Hansa
...
- Defensive Tactics  — 175cul (10t) — unlocks: Bastions, Limes — inspiration: Be the target of a Declaration of War.
...
- **current:** Iron Working — 60/120sci (3t)
...
- **current:** Defensive Tactics — 27/175cul (10t)
...
- **luxuries:** Ivory
- **owned bonus tiles:** 3× Stone, 2× Bananas (1/2 improved), 2× Cattle, 2× Rice (1/2 improved), Fish (0/1 improved)
...
## GREAT PEOPLE
- **GENERAL** 9pts (+1.2/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 39pts (+1.2/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 37pts (+2.3/turn) — next recruit cost 120 — candidate: Omar Khayyam
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 4 | grow 37t (food+1.0) | hous 10 | amen 3/1 | happ Happy | border+12t | growth +10%
- yields: F9.0 P17.3 G9.4 S9.2 C6.5 Fa12.6
- **producing:** Barracks (60/90, 2t)
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options: Scout (2t), Barracks (2t), Warrior (3t), Trader (4t), Archer (4t), Spearman (4t), Battering Ram (4t), Builder (5t), Horseman (5t), Siege Tower (6t)
    - ...15 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 7 | grow 35t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+6t | growth -15%
...
- defense: str 22 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (5t), Warrior (6t), Archer (9t), Trader (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Horseman (12t), Ancient Walls (12t), Water Mill (12t)
    - ...17 more options in JSON
### SHEDET @ (66,25)
- pop 6 | grow 11t (food+7.0) | hous 8 | amen 1/2 | happ Displeased | border+15t | growth -15%
- yields: F19.0 P8.6 G2.9 S4.0 C2.7 Fa1.0
- **producing:** Monument (24/60, 5t)
- defense: str 23 | garrison 200/200 | walls 100/100
    ...
    - top production options: Scout (4t), Warrior (5t), Monument (5t), Trader (8t), Archer (8t), Spearman (8t), Battering Ram (8t), Horseman (10t), Water Mill (10t), Builder (11t)
    - ...15 more options in JSON
### Luxis @ (64,22)
- pop 3 | grow 12t (food+2.0) | hous 5 | amen 1/1 | happ Content | border+1t
- yields: F8.0 P5.0 G3.0 S3.1 C2.9 Fa1.0
- **producing:** Granary (33/65, 7t)
- defense: str 10 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (6t), Granary (7t), Warrior (8t), Archer (12t), Spearman (13t), Battering Ram (13t), Trader (14t), Horseman (16t), Ancient Walls (16t), Water Mill (16t)
    - ...16 more options in JSON

## UNITS (7)
- **Scout** #196608 @(55,19) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
...
## DIPLOMACY
- **envoys:** 0 in hand | 62/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 132 mil 131 | met T27
    - public: techs 20 | civics 11 | tourism 4
...
- Amsterdam (city-state): 4 unit(s) — 2× WARRIOR, ARCHER, BUILDER
...
## REVEALED MAP
_614 revealed, 174 currently visible, 1 natural wonders_
...
53,19 0|gm|||||||0||A4|
54,19 1|gm|||||||0||A4|
55,19 1|gh||TEA|||||0|0:SCOUT:100|A3/F|
56,19 1|gh|||||||0||R/A3/F|
57,19 1|gh|||||||0||R/A1/F|
58,19 0|g|mar||||||0||A1|
59,19 0|p|jun||||||0||A-1|
...
66,21 1|g||||1|||0||A2|
67,21 1|g|||||||0|||
68,21 1|g||RICE|||11||0|11:BUILDER:100|R/A1/F|
69,21 1|gh|||||||0||R/A2/F|
70,21 0|co|||||||0|||
71,21 0|co|||||||0|||
72,21 0|oc|||||||0|||
...
- per-query timing (s): meta=0.376, choices=0.347, cities=0.377, units=0.345, map=0.378, diplo=0.36, religion=0.346, notif=0.328
- **failures at runtime:**
...
- last trace per query (for post-mortem):
    ...
    - `map`: (no traces)
    - `diplo`: TRACE|DIPLO|gossip_probe
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=105 generated_at=1785311467.9207637 failed_sections=none -->
