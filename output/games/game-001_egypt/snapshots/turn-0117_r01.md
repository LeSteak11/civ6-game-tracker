# CIV6 COACH SNAPSHOT — turn 117
_Egypt (Cleopatra) — 25 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## EMPIRE
- **score:** 123
- **gold:** 626 (net +9.2 = yield 17.2 − maint 8.0)
- **science:** 22.3/turn
- **culture:** 18.4/turn
- **faith:** 748 (+22.2/turn)
- **tourism:** 20.0/turn
...
## RESEARCH / CIVIC
- **tech:** Mathematics 44/200 (7t) — eureka:False [need: Build 3 different specialty districts.]
- **civic:** Feudalism 194/275 (5t) — inspiration:True
...
- Mathematics  — 200sci (7t) — unlocks: Petra — boost: Build 3 different specialty districts.
...
- Feudalism ★ — 275cul (5t) — unlocks: Feudal Contract, Serfdom
...
- **current:** Mathematics — 44/200sci (7t)
...
- **current:** Feudalism — 194/275cul (5t)
...
## GREAT PEOPLE
- **GENERAL** 35pts (+2.3/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 67pts (+2.3/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 65pts (+2.3/turn) — next recruit cost 120 — candidate: Hildegard of Bingen
...
### Sais @ (62,26)
- pop 7 | grow 23t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+18t | growth -15%
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa7.6
- prod sources: tiles 6.0, other +0.7 (see JSON for all yields)
- **producing:** Temple (81/120, 6t)
- defense: str 27 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 28): Scout (5t), Temple (6t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Trader (11t), Horseman (13t), Ancient Walls (13t), Water Mill (13t)
    ...
    - unavailable (showing 6 of 43; full list + reasons in JSON):
        ...
        - Market — This building requires a Commercial Hub district.
### SHEDET @ (66,25)
- pop 7 | grow 24t (food+7.0) | hous 8 | amen 1/3 | happ Displeased | border+14t | growth -15%
- yields: F21.0 P9.5 G2.9 S4.7 C4.8 Fa1.0
- prod sources: tiles 9.0, other +0.5 (see JSON for all yields)
- **producing:** Builder (67/90, 3t)
- defense: str 28 | garrison 200/200 | walls 100/100
    ...
    - top production options (showing 10 of 25): Builder (3t), Scout (4t), Archer (7t), Spearman (7t), Battering Ram (7t), Trader (8t), Horseman (9t), Water Mill (9t), Siege Tower (11t), Catapult (13t)
...
- defense: str 25 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 26): Scout (6t), Archer (12t), Builder (13t), Spearman (13t), Battering Ram (13t), Trader (14t), Horseman (16t), Ancient Walls (16t), Water Mill (16t), Siege Tower (20t)
...
## UNITS (9)
- **Scout** #196608 @(67,33) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
- **Builder** #1572865 @(66,33) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch2 <IDLE>
- **Trader** #786434 @(62,26) | hp100/100 | mv2/2 | cs0 rs0 xp0/15
- **Warrior** #655363 @(62,26) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 fort:2
- **Spearman** #1638404 @(65,25) | hp100/100 | mv2/2 | cs25 rs0 xp0/15 fort:1
...
## DIPLOMACY
- **envoys:** 0 in hand | 98/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
...
- **units visible (1):** Scout @(67,13) hp100/100
...
## REVEALED MAP
_617 revealed, 152 currently visible, 1 natural wonders_
...
66,13 1|g|||||||0||R/A-2/F|
67,13 1|g||TOBACCO|||||0|63:SCOUT:100|R/F|
68,13 0|g|||||||0||R/A4/F|
...
64,33 1|oc|||||||0|||
65,33 1|co|||||||0|||
66,33 1|g|mar||||||0|0:BUILDER:100|A1|
67,33 1|g|for|DEER|||||0|0:SCOUT:100|A2|
68,33 1|co|||||||0|||
69,33 1|oc|||||||0|||
65,34 1|co|||||||0|||
...
- per-query timing (s): meta=0.378, choices=0.36, cities=0.393, units=0.343, map=0.36, diplo=0.357, religion=0.347, notif=0.344
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=117 generated_at=1785313618.7843 failed_sections=none counts: cities=4 units=9 tiles=617 majors=1 city_states=4 gossip=19 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=36235 -->
