# CIV6 COACH SNAPSHOT — turn 98
_Egypt (Cleopatra) — 450 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.2 coach 1.2.1_
...
## EMPIRE
- **score:** 106
- **gold:** 476 (net +15.4 = yield 18.4 − maint 3.0)
- **science:** 19.0/turn
- **culture:** 13.1/turn
- **faith:** 346 (+17.5/turn)
- **tourism:** 19.0/turn
...
- **cities / units / pop:** 4 / 7 / 17
- **trade routes:** 1/1
- **explored land:** 438/1153 tiles
- **enabled victories:** VICTORY_TECHNOLOGY, VICTORY_CULTURE, VICTORY_RELIGIOUS, VICTORY_CONQUEST, VICTORY_SCORE

## RESEARCH / CIVIC
- **tech:** Engineering 93/200 (6t) — eureka:False [need: Build Ancient Walls.]
- **civic:** Theology 101/120 (2t) — inspiration:True

### TECHS AVAILABLE (up to 10, sorted by turns)
- Engineering  — 200sci (6t) — unlocks: Catapult, Aqueduct, Bath — boost: Build Ancient Walls.
...
- Theology ★ — 120cul (2t) — unlocks: Scripture
...
- **current:** Engineering — 93/200sci (6t)
...
- **current:** Theology — 101/120cul (2t)
...
## GREAT PEOPLE
- **GENERAL** 1pts (+1.2/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 31pts (+1.2/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 21pts (+2.3/turn) — next recruit cost 120 — candidate: Abu al-Qasim al-Zahrawi
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 5t (food+2.0) | hous 10 | amen 3/1 | happ 5 | border+1t
- yields: F8.0 P16.0 G10.5 S8.5 C6.2 Fa13.6
- **producing:** Builder (57/78, 2t)
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options: Builder (2t), Scout (2t), Warrior (3t), Trader (4t), Archer (4t), Spearman (5t), Battering Ram (5t), Horseman (5t), Ancient Walls (6t), Siege Tower (7t)
    - ...13 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 7 | grow 42t (food+8.0) | hous 7 | amen 2/3 | happ 3 | border+13t
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa2.9
- **producing:** Shrine (24/70, 7t)
- defense: str 22 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (5t), Warrior (7t), Shrine (7t), Trader (10t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Builder (12t), Horseman (13t)
    - ...14 more options in JSON
### SHEDET @ (66,25)
- pop 5 | grow 7t (food+6.0) | hous 7 | amen 1/2 | happ 3 | border+2t
- yields: F16.0 P7.6 G2.9 S3.3 C2.4 Fa1.0
- **producing:** Builder (71/78, 1t)
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - top production options: Builder (1t), Scout (4t), Warrior (6t), Archer (8t), Monument (8t), Trader (9t), Spearman (9t), Battering Ram (9t), Horseman (11t), Ancient Walls (11t)
    - ...13 more options in JSON
### Luxis @ (64,22)
- pop 2 | grow 2t (food+2.0) | hous 5 | amen 1/0 | happ 5 | border+4t
...
- defense: str 10 | garrison 200/200 | walls 0/0
    ...
    - top production options: Monument (1t), Scout (8t), Warrior (10t), Archer (15t), Trader (16t), Spearman (16t), Battering Ram (16t), Granary (16t), Builder (19t), Horseman (20t)
    - ...14 more options in JSON

## UNITS (7)
- **Scout** #196608 @(51,21) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
- **Warrior** #131073 @(66,29) | hp100/100 | mv2/2 | cs20 rs0 xp14/15 fort:1
...
## DIPLOMACY
- **envoys:** 0 in hand | 41/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 117 mil 157 | met T27 | OB from them
### CITY-STATES MET
...
## REVEALED MAP
_541 revealed, 101 currently visible, 1 natural wonders_
...
- per-query timing (s): meta=0.37, choices=0.361, cities=0.359, units=0.343, map=0.364, diplo=0.341, religion=0.343, notif=0.344
...
<!-- coach snapshot: schema=coach-snapshot/1.2 turn=98 generated_at=1785309931.389437 failed_sections=none -->
