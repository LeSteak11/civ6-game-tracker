# CIV6 COACH SNAPSHOT — turn 88
_Egypt (Cleopatra) — 700 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.2 coach 1.2.1_
...
## EMPIRE
- **score:** 79
- **gold:** 340 (net +10.4 = yield 12.4 − maint 2.0)
- **science:** 17.1/turn
- **culture:** 12.3/turn
- **faith:** 191 (+14.6/turn)
- **tourism:** 11.0/turn
...
## RESEARCH / CIVIC
- **tech:** Construction 110/200 (6t) — eureka:False [need: Build a Water Mill.]
- **civic:** Military Tradition 18/50 (3t) — inspiration:False [need: Clear a Barbarian Outpost.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Construction  — 200sci (6t) — unlocks: Siege Tower, Terracotta Army — boost: Build a Water Mill.
...
- Military Tradition  — 50cul (3t) — unlocks: Maneuver, Strategos — inspiration: Clear a Barbarian Outpost.
...
- **current:** Construction — 110/200sci (6t)
...
- **current:** Military Tradition — 18/50cul (3t)
- **available now:** 2 (top picks listed above)
- **partially banked:** Drama and Poetry (55/110cul), Military Training (60/120cul)
...
## GREAT PEOPLE
- **GENERAL** 50pts (+1.1/turn) — next recruit cost 60 — candidate: Sun Tzu
...
- **PROPHET** 28pts (+2.3/turn) — next recruit cost 120 — candidate: Bodhidharma
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 23t (food+1.0) | hous 10 | amen 3/1 | happ 5 | border+11t
- yields: F7.0 P12.6 G10.5 S8.5 C6.2 Fa13.6
...
- defense: str 23 | garrison 200/200 | walls 0/0
    ...
    - tiles: 15 owned, 4 worked | terrain: 8 plains, 5 plains_hills, 1 grass_hills, 1 grass | features: 1 forest, 1 marsh | improvements: 3 farm, 2 mine, 2 sphinx, 1 camp
    - top production options: Scout (3t), Warrior (3t), Trader (5t), Archer (5t), Spearman (5t), Battering Ram (5t), Builder (6t), Horseman (6t), Ancient Walls (7t), Water Mill (7t)
    - ...12 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 6 | grow 6t (food+8.0) | hous 7 | amen 1/2 | happ 3 | border+5t
- yields: F20.0 P6.7 G1.9 S4.0 C3.6 Fa0.0
- **producing:** Holy Site (89/131, 7t)
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (5t), Warrior (7t), Holy Site (7t), Trader (10t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Builder (12t), Horseman (13t)
    - ...11 more options in JSON
### SHEDET @ (66,25)
- pop 4 | grow 4t (food+5.0) | hous 5 | amen 1/1 | happ 4 | border+13t
- yields: F13.0 P6.0 G0.0 S2.8 C2.2 Fa1.0
- **producing:** Granary (24/65, 7t)
- defense: str 20 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (66,25)
    - tiles: 9 owned, 5 worked | terrain: 6 grass, 1 grass_hills, 1 plains, 1 coast | features: 1 forest, 1 marsh | improvements: 2 quarry, 1 farm, 1 sphinx
    - top production options: Scout (5t), Builder (6t), Warrior (7t), Granary (7t), Archer (10t), Monument (10t), Trader (11t), Spearman (11t), Battering Ram (11t), Horseman (14t)
    - ...12 more options in JSON
### Luxis @ (64,22)
- pop 1 | grow 1t (food+2.0) | hous 5 | amen 1/0 | happ 5 | border+27t
- yields: F4.0 P3.1 G0.0 S1.8 C0.3 Fa0.0
- **producing:** Monument (18/60, 14t)
- defense: str 10 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (10t), Warrior (13t), Monument (14t), Trader (20t), Archer (20t), Spearman (21t), Battering Ram (21t), Granary (21t), Builder (25t), Horseman (26t)
    - ...12 more options in JSON

## UNITS (7)
- **Scout** #196608 @(49,19) | hp100/100 | mv3/3 | cs10 rs0 xp15/45
- **Warrior** #131073 @(66,29) | hp84/100 | mv2/2 | cs20 rs0 xp7/15
- **Trader** #786434 @(65,24) | hp100/100 | mv2/2 | cs0 rs0 xp0/15
- **Warrior** #655363 @(62,26) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 fort:2
- **Great Prophet** #1245189 @(66,29) | hp100/100 | mv4/4 | cs0 rs0 xp0/15 <IDLE>
- **Archer** #1048582 @(67,29) | hp100/100 | mv2/2 | cs15 rs25 xp22/45 <IDLE>
- **Warrior** #983047 @(66,25) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 fort:2

## DIPLOMACY
- **envoys:** 0 in hand | 11/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 98 mil 170 | met T27 | OB from them
...
- **units visible (1):** Galley @(69,25) hp72/100
...
## REVEALED MAP
_508 revealed, 98 currently visible, 1 natural wonders_
...
68,25 1|co||FISH|||0||0|||
69,25 1|co||FISH|||||0|63:GALLEY:72||
59,26 0|co|||||||0|||
60,26 1|g|||||||0||A3|
...
66,29 1|ph||||1|0|CITY_CENTER|1|0:WARRIOR:84;0:GREAT_PROPHET:100|R/F|Râ-Kedet
...
- per-query timing (s): meta=0.379, choices=0.361, cities=0.36, units=0.346, map=0.364, diplo=0.345, religion=0.347, notif=0.346
...
<!-- coach snapshot: schema=coach-snapshot/1.2 turn=88 generated_at=1785307829.4155474 failed_sections=none -->
