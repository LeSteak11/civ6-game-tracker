# CIV6 COACH SNAPSHOT — turn 139
_Egypt (Cleopatra) — 560 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## EMPIRE
- **score:** 140
- **gold:** 591 (net +22.0 = yield 37.0 − maint 15.0)
- **science:** 25.4/turn
- **culture:** 20.8/turn
- **faith:** 1314 (+27.5/turn)
- **tourism:** 20.0/turn
- **military:** 219
- **techs / civics done:** 20 / 15
- **cities / units / pop:** 4 / 12 / 26
- **trade routes:** 1/1
...
## RESEARCH / CIVIC
- **tech:** Stirrups 267/390 (5t) — eureka:True
- **civic:** Civil Service 179/275 (5t) — inspiration:False [need: Grow a city to 10 population.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Stirrups ★ — 390sci (5t) — unlocks: Knight, Mamluk
...
- Mercenaries ★ — 290cul (7t) — unlocks: Sack, Professional Army, Trade Confederation
...
- **current:** Stirrups — 267/390sci (5t)
...
- **current:** Civil Service — 179/275cul (5t)
- **available now:** 3 (top picks listed above)
- **partially banked:** Mercenaries (145/290cul)
...
## GREAT PEOPLE
- **GENERAL** 87pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
- **ADMIRAL** 0pts (+0.0/turn) — next recruit cost 120 — candidate: Leif Erikson
- **ENGINEER** 30pts (+2.4/turn) — next recruit cost 120 — candidate: Bi Sheng
- **MERCHANT** 0pts (+0.0/turn) — next recruit cost 60 — candidate: Zhang Qian
- **PROPHET** 138pts (+3.6/turn) — next recruit cost 240 — candidate: Martin Luther
- **SCIENTIST** 98pts (+2.4/turn) — next recruit cost 240 — candidate: Emilie du Chatelet
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 5 | grow STARVE 23t (food-1.0) | hous 12 | amen 4/2 | happ Happy | border+22t | growth +10%
- yields: F9.0 P27.3 G24.1 S10.0 C6.8 Fa12.6
- prod sources: tiles 15.0, bldgs 6, adj 1, other +5.3 (see JSON for all yields)
- **producing:** Horseman (40/80, 2t)
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options (showing 10 of 26): Scout (2t), Horseman (2t), Trader (3t), Archer (3t), Spearman (3t), Battering Ram (3t), Builder (4t), Siege Tower (4t), Catapult (5t), Maryannu Chariot Archer (5t)
...
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 28): Scout (5t), Water Mill (5t), Archer (9t), Spearman (10t), Battering Ram (10t), Trader (11t), Horseman (12t), Ancient Walls (12t), Builder (15t), Siege Tower (15t)
...
### SHEDET @ (66,25)
- pop 8 | grow 30t (food+13.0) | hous 8 | amen 2/3 | happ Displeased | border+6t | growth -15%
- yields: F29.0 P9.5 G2.9 S5.3 C6.1 Fa1.9
...
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - tiles: 12 owned, 9 worked | terrain: 8 grass, 1 plains, 1 coast, 1 grass_hills, 1 grass_mountain | features: 1 marsh, 1 forest | improvements: 3 quarry, 3 farm, 2 sphinx
    - top production options (showing 10 of 26): Scout (3t), Archer (6t), Spearman (7t), Battering Ram (7t), Trader (8t), Horseman (8t), Builder (10t), Siege Tower (11t), Catapult (13t), Maryannu Chariot Archer (13t)
    - ...16 more options in JSON
    - unavailable (showing 6 of 50; full list + reasons in JSON):
        ...
        - Oracle — blocked (reason not exposed by engine)
### Luxis @ (64,22)
- pop 5 | grow 2t (food+6.0) | hous 8 | amen 2/2 | happ Content | border+15t
- yields: F16.0 P8.0 G8.0 S4.5 C3.5 Fa1.0
- prod sources: tiles 7.0, other +1.0 (see JSON for all yields)
- **producing:** Water Mill (74/80, 1t)
- defense: str 35 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - buildings in `CITY_CENTER`: Monument, Granary
    - tiles: 11 owned, 6 worked | terrain: 7 grass, 1 grass_mountain, 1 plains_hills, 1 grass_hills, 1 plains | features: 2 jungle, 2 forest | improvements: 2 farm, 1 mine, 1 plantation
    - top production options (showing 10 of 28): Water Mill (1t), Scout (4t), Archer (8t), Spearman (9t), Battering Ram (9t), Trader (10t), Horseman (10t), Ancient Walls (10t), Builder (13t), Siege Tower (13t)
    - ...18 more options in JSON
    - unavailable (showing 6 of 50; full list + reasons in JSON):
        - Great Library — Requires Library [reconstructed: BuildingPrereqs]
        - Mahabodhi Temple — Requires Temple [reconstructed: BuildingPrereqs]
...
## UNITS (12)
- **Builder** #1900544 @(64,23) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch1 <IDLE>
- **Scout** #1835009 @(73,10) | hp100/100 | mv3/3 | cs10 rs0 xp15/15 (+1 avail) fort:2 <IDLE>
...
- **Settler** #1966088 @(67,33) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 <IDLE>
- **Man-At-Arms** #1769481 @(67,33) | hp100/100 | mv2/2 | cs45 rs0 xp15/45 <IDLE>
- **Archer** #2031626 @(65,26) | hp100/100 | mv2/2 | cs15 rs25 xp0/15 fort:2
- **Archer** #2097163 @(66,25) | hp100/100 | mv2/2 | cs15 rs25 xp0/15 <IDLE>

## DIPLOMACY
- **envoys:** 0 in hand | 6/100 pts (+5.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 182 mil 131 | met T27
...
## REVEALED MAP
_660 revealed, 221 currently visible, 2 natural wonders_
...
68,16 1|dh|||||||0|11:SWORDSMAN:100|F|
69,16 1|d|||||||0||A2/F|
...
66,25 1|p||||1|0|CITY_CENTER|1|0:WARRIOR:100;0:ARCHER:100|R/A-2/F|SHEDET
...
65,33 1|co|||||||0|||
66,33 1|g|mar||||||0||A1|
67,33 1|g|for|DEER|||||0|0:SETTLER:100;0:MAN_AT_ARMS:100|A2|
68,33 1|co|||||||0|||
69,33 1|oc|||||||0|||
70,33 1|oc|||||||0|||
65,34 1|co|||||||0|||
...
- per-query timing (s): meta=0.38, choices=0.362, cities=0.41, units=0.345, map=0.378, diplo=0.357, religion=0.36, notif=0.343
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=139 generated_at=1785396624.6084912 failed_sections=none counts: cities=4 units=12 tiles=660 majors=1 city_states=4 gossip=22 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=38295 -->
