# CIV6 COACH SNAPSHOT — turn 109
_Egypt (Cleopatra) — 175 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.5.0_
...
## EMPIRE
- **score:** 117
- **gold:** 546 (net +10.2 = yield 17.2 − maint 7.0)
- **science:** 21.0/turn
- **culture:** 16.0/turn
- **faith:** 570 (+22.2/turn)
- **tourism:** 19.0/turn
...
## RESEARCH / CIVIC
- **tech:** Apprenticeship 174/300 (6t) — eureka:True
- **civic:** Defensive Tactics 91/175 (6t) — inspiration:False [need: Be the target of a Declaration of War.]
...
- Apprenticeship ★ — 300sci (6t) — unlocks: Man-At-Arms, Workshop, Industrial Zone, Hansa
...
- Defensive Tactics  — 175cul (6t) — unlocks: Bastions, Limes — inspiration: Be the target of a Declaration of War.
...
- **current:** Apprenticeship — 174/300sci (6t)
...
- **current:** Defensive Tactics — 91/175cul (6t)
...
## GREAT PEOPLE
- **GENERAL** 16pts (+2.3/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 48pts (+2.3/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 46pts (+2.3/turn) — next recruit cost 120 — candidate: Omar Khayyam
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 4 | grow 33t (food+1.0) | hous 11 | amen 3/1 | happ Happy | border+8t | growth +10%
- yields: F9.0 P20.5 G9.4 S9.2 C6.5 Fa12.6
- prod sources: tiles 11.0, bldgs 4, trade 1, other +4.5 (see JSON for all yields)
- **producing:** Builder (46/86, 2t)
- defense: str 33 | garrison 200/200 | walls 100/100
- majority religion: RELIGION_TAOISM
    ...
    - top production options: Builder (2t), Scout (2t), Archer (3t), Trader (4t), Spearman (4t), Battering Ram (4t), Horseman (4t), Swordsman (5t), Siege Tower (5t), Catapult (6t)
    - ...13 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 7 | grow 31t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+2t | growth -15%
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa7.6
- prod sources: tiles 6.0, other +0.7 (see JSON for all yields)
- **producing:** Temple (27/120, 14t)
...
### SHEDET @ (66,25)
- pop 6 | grow 7t (food+7.0) | hous 8 | amen 1/2 | happ Displeased | border+11t | growth -15%
- yields: F19.0 P8.6 G2.9 S4.0 C2.7 Fa1.0
- prod sources: tiles 8.0, other +0.6 (see JSON for all yields)
- **producing:** Monument (58/60, 1t)
- defense: str 28 | garrison 200/200 | walls 100/100
    ...
    - top production options: Monument (1t), Scout (4t), Trader (8t), Archer (8t), Spearman (8t), Battering Ram (8t), Horseman (10t), Water Mill (10t), Builder (11t), Swordsman (11t)
    - ...15 more options in JSON
### Luxis @ (64,22)
- pop 3 | grow 8t (food+2.0) | hous 5 | amen 1/1 | happ Content | border+9t
- yields: F8.0 P5.0 G3.0 S3.1 C2.9 Fa1.0
- prod sources: tiles 4.0, other +1.0 (see JSON for all yields)
- **producing:** Granary (53/65, 3t)
- defense: str 25 | garrison 200/200 | walls 0/0
    ...
    - top production options: Granary (3t), Scout (6t), Archer (12t), Spearman (13t), Battering Ram (13t), Trader (14t), Horseman (16t), Ancient Walls (16t), Water Mill (16t), Builder (18t)
    - ...16 more options in JSON

## UNITS (7)
- **Scout** #196608 @(61,16) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
...
- **Archer** #1048582 @(66,29) | hp100/100 | mv2/2 | cs15 rs25 xp25/45
- **Warrior** #983047 @(66,25) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 fort:2
- **Swordsman** #1507336 @(66,31) | hp77/100 | mv3/3 | cs35 rs0 xp15/15 <IDLE>

## DIPLOMACY
- **envoys:** 0 in hand | 74/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 140 mil 155 | met T27 | OB from them
...
## REVEALED MAP
_616 revealed, 155 currently visible, 1 natural wonders_
...
59,16 1|gm|||||||0||A4|
60,16 1|p|||||||0|||
61,16 1|p||HORSES|||||0|0:SCOUT:100|A-2|
62,16 1|g|mar||||||0||A-2|
...
65,21 1|g|for||||||0||A1|
66,21 1|g||||1|||0|11:WARRIOR:100|A2|
67,21 1|g|||||||0|||
...
66,29 1|ph||||1|0|CITY_CENTER|1|0:GREAT_GENERAL:100;0:ARCHER:100|R/F|Râ-Kedet
...
- per-query timing (s): meta=0.372, choices=0.358, cities=0.392, units=0.347, map=0.365, diplo=0.347, religion=0.345, notif=0.347
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=109 generated_at=1785312163.105178 failed_sections=none -->
