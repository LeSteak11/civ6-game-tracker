...
- turns elapsed: 1
- empire: gold: +10.200000000000045, faith: +22.09999999999991, military: +2
- units moved: 3
...
## UNITS (8)
- **Scout** #196608 @(64,18) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
- **Builder** #1572865 @(67,30) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch3
...
## REVEALED MAP
_617 revealed, 146 currently visible, 1 natural wonders_
...
62,17 1|p|jun|BANANAS||1|||0|7:WARRIOR:100|A-1|
63,17 1|d|||||||0|||
64,17 1|p|jun||||||0|||
65,17 1|p|jun||||||0||A-1|
...
63,18 1|g|for||||||0||A1|
64,18 1|g|for||||||0|0:SCOUT:100|A2|
...
- per-query timing (s): meta=0.372, choices=0.358, cities=0.375, units=0.347, map=0.361, diplo=0.359, religion=0.33, notif=0.344
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=112 generated_at=1785312938.0589685 failed_sections=none -->
