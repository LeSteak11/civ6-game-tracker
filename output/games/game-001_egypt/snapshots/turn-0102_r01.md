# CIV6 COACH SNAPSHOT — turn 102
_Egypt (Cleopatra) — 350 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.3 coach 1.3.0_
...
## EMPIRE
- **score:** 109
- **gold:** 535 (net +14.2 = yield 17.2 − maint 3.0)
- **science:** 19.6/turn
- **culture:** 15.4/turn
- **faith:** 421 (+20.3/turn)
- **tourism:** 19.0/turn
...
- **civic:** Military Training 100/120 (2t) — inspiration:True
...
- Military Training ★ — 120cul (2t) — unlocks: Raid, Veterancy
...
- **current:** Military Training — 100/120cul (2t)
...
## GREAT PEOPLE
- **GENERAL** 6pts (+1.2/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 36pts (+1.2/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 30pts (+2.3/turn) — next recruit cost 120 — candidate: Omar Khayyam
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 1t (food+2.0) | hous 10 | amen 3/1 | happ 5 | border+16t
- yields: F8.0 P13.9 G9.4 S8.5 C6.2 Fa12.6
- **producing:** Ancient Walls (33/80, 4t)
...
- majority religion: RELIGION_TAOISM
    ...
    - tiles: 16 owned, 4 worked | terrain: 9 plains, 5 plains_hills, 1 grass, 1 grass_hills | features: 1 marsh, 1 forest | improvements: 4 farm, 2 mine, 2 sphinx, 1 camp
    - top production options: Scout (2t), Warrior (3t), Archer (4t), Ancient Walls (4t), Trader (5t), Spearman (5t), Battering Ram (5t), Horseman (5t), Builder (6t), Siege Tower (7t)
    - ...16 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 7 | grow 38t (food+8.0) | hous 7 | amen 2/3 | happ 3 | border+9t
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa5.7
- **producing:** Shrine (51/70, 3t)
- defense: str 22 | garrison 200/200 | walls 0/0
    ...
    - top production options: Shrine (3t), Scout (5t), Warrior (7t), Trader (10t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Builder (13t), Horseman (13t)
    - ...18 more options in JSON
### SHEDET @ (66,25)
- pop 5 | grow 3t (food+6.0) | hous 7 | amen 1/2 | happ 3 | border+20t
...
- defense: str 23 | garrison 200/200 | walls 100/100
    ...
    - tiles: 10 owned, 6 worked | terrain: 7 grass, 1 plains, 1 coast, 1 grass_hills | features: 1 marsh, 1 forest | improvements: 2 quarry, 1 sphinx, 1 farm
    - top production options: Scout (4t), Warrior (6t), Archer (8t), Monument (8t), Trader (9t), Spearman (9t), Battering Ram (9t), Horseman (11t), Water Mill (11t), Builder (12t)
    - ...15 more options in JSON
### Luxis @ (64,22)
- pop 3 | grow 15t (food+2.0) | hous 5 | amen 1/1 | happ 4 | border+4t
- yields: F8.0 P5.0 G3.0 S3.1 C2.9 Fa1.0
- **producing:** Granary (18/65, 10t)
- defense: str 10 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (6t), Warrior (8t), Granary (10t), Archer (12t), Spearman (13t), Battering Ram (13t), Trader (14t), Horseman (16t), Ancient Walls (16t), Water Mill (16t)
    - ...16 more options in JSON

## UNITS (9)
- **Scout** #196608 @(54,22) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
...
- **Builder** #1376260 @(67,25) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch2 <IDLE>
...
- **Builder** #1441800 @(64,29) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch2 <IDLE>

## DIPLOMACY
- **envoys:** 0 in hand | 53/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 130 mil 132 | met T27
...
- `NOTIFICATION_TECH_DISCOVERED`: Discovered Engineering
...
## REVEALED MAP
_591 revealed, 137 currently visible, 1 natural wonders_
...
67,25 1|g|||||0||0|0:BUILDER:100|A2|
68,25 1|co||FISH|||0||0|||
69,25 1|co||FISH|||||0|||
52,26 0|oc|||||||0|||
53,26 0|co||FISH|||||0|||
...
64,29 1|p|||FARM|1|0||0|0:BUILDER:100|A2|
...
- per-query timing (s): meta=0.379, choices=0.36, cities=0.359, units=0.343, map=0.363, diplo=0.357, religion=0.344, notif=0.343
...
<!-- coach snapshot: schema=coach-snapshot/1.3 turn=102 generated_at=1785311012.14113 failed_sections=none -->
