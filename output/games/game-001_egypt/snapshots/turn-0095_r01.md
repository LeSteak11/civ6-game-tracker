# CIV6 COACH SNAPSHOT — turn 95
_Egypt (Cleopatra) — 525 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.2 coach 1.2.1_
...
## EMPIRE
- **score:** 98
- **gold:** 435 (net +12.6 = yield 15.6 − maint 3.0)
- **science:** 19.0/turn
- **culture:** 13.1/turn
- **faith:** 293 (+17.5/turn)
- **tourism:** 19.0/turn
...
- **cities / units / pop:** 4 / 6 / 17
- **trade routes:** 1/1
- **explored land:** 435/1153 tiles
- **enabled victories:** VICTORY_TECHNOLOGY, VICTORY_CULTURE, VICTORY_RELIGIOUS, VICTORY_CONQUEST, VICTORY_SCORE

## RESEARCH / CIVIC
- **tech:** Engineering 36/200 (9t) — eureka:False [need: Build Ancient Walls.]
...
- Engineering  — 200sci (9t) — unlocks: Catapult, Aqueduct, Bath — boost: Build Ancient Walls.
...
- Theology ★ — 120cul (5t) — unlocks: Scripture
- Defensive Tactics  — 175cul (14t) — unlocks: Bastions, Limes — inspiration: Be the target of a Declaration of War.
- Recorded History  — 175cul (14t) — unlocks: Natural Philosophy — inspiration: Build 2 Campus districts.
...
- **current:** Engineering — 36/200sci (9t)
...
- **partially banked:** Military Training (60/120cul), Theology (60/120cul)
...
## GREAT PEOPLE
- **GENERAL** 58pts (+1.2/turn) — next recruit cost 60 — candidate: Sun Tzu
...
- **PROPHET** 28pts (+0.0/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 14pts (+2.3/turn) — next recruit cost 120 — candidate: Abu al-Qasim al-Zahrawi
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 8t (food+2.0) | hous 10 | amen 3/1 | happ 5 | border+4t
- yields: F8.0 P13.9 G10.5 S8.5 C6.2 Fa13.6
...
- majority religion: RELIGION_TAOISM
    ...
    - tiles: 15 owned, 4 worked | terrain: 8 plains, 5 plains_hills, 1 grass, 1 grass_hills | features: 1 marsh, 1 forest | improvements: 3 farm, 2 sphinx, 2 mine, 1 camp
    - top production options: Scout (2t), Warrior (2t), Trader (4t), Archer (4t), Spearman (4t), Battering Ram (4t), Builder (5t), Horseman (5t), Siege Tower (6t), Barracks (6t)
    - ...13 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 7 | grow 45t (food+8.0) | hous 7 | amen 2/3 | happ 3 | border+16t
...
- defense: str 22 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (4t), Warrior (6t), Trader (9t), Archer (9t), Spearman (10t), Battering Ram (10t), Granary (10t), Shrine (10t), Builder (12t), Horseman (12t)
    - ...14 more options in JSON
### SHEDET @ (66,25)
- pop 5 | grow 10t (food+6.0) | hous 7 | amen 1/2 | happ 3 | border+5t
- yields: F16.0 P7.6 G0.0 S3.3 C2.4 Fa1.0
- **producing:** Builder (42/78, 4t)
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - top production options: Builder (4t), Scout (4t), Warrior (5t), Trader (8t), Archer (8t), Spearman (8t), Battering Ram (8t), Monument (8t), Horseman (10t), Ancient Walls (10t)
    - ...13 more options in JSON
### Luxis @ (64,22)
- pop 2 | grow 5t (food+2.0) | hous 5 | amen 1/0 | happ 5 | border+7t
- yields: F6.0 P4.2 G3.1 S2.5 C0.6 Fa0.0
- **producing:** Monument (47/60, 4t)
- defense: str 10 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - tiles: 7 owned, 3 worked | terrain: 4 grass, 1 grass_mountain, 1 plains, 1 grass_hills | features: 1 jungle
    - top production options: Monument (4t), Scout (8t), Warrior (10t), Archer (15t), Trader (16t), Spearman (16t), Battering Ram (16t), Granary (16t), Builder (19t), Horseman (20t)
    - ...14 more options in JSON

## UNITS (6)
- **Scout** #196608 @(48,23) | hp100/100 | mv0/3 | cs10 rs0 xp16/45
- **Warrior** #131073 @(66,29) | hp100/100 | mv2/2 | cs20 rs0 xp7/15 fort:2
- **Trader** #786434 @(66,27) | hp100/100 | mv2/2 | cs0 rs0 xp0/15
- **Warrior** #655363 @(62,26) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 fort:2
- **Archer** #1048582 @(67,29) | hp100/100 | mv2/2 | cs15 rs25 xp23/45 <IDLE>
- **Warrior** #983047 @(66,25) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 fort:2

## DIPLOMACY
- **envoys:** 0 in hand | 32/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 114 mil 145 | met T27 | OB from them
### CITY-STATES MET
...
- **units visible (2):** Galley @(48,24) hp100/100; Warrior @(66,30) hp52/100
...
- `NOTIFICATION_CIVIC_DISCOVERED`: Discovered Drama and Poetry
...
## REVEALED MAP
_538 revealed, 108 currently visible, 1 natural wonders_
...
72,10 0|g|||||||0|||
73,10 0|g|||||||0||A1|
52,11 0|g|mar||||3||0||R/A-1/F|
53,11 0|g|||ZIGGURAT:P||3||0||R/A-1/F|
...
49,12 0|gh||||0|3||0|||
52,12 0|g||TEA|||3||0|||
53,12 0|g||||1|3|CITY_CENTER|1||R/F|Lagash
...
46,23 1|co||CRABS|||||0|||
47,23 1|co|||||||0|||
48,23 1|g|for|IVORY|||||0|0:SCOUT:100|A4|
49,23 1|co|||||||0|||
50,23 1|co|||||||0|||
...
66,29 1|ph||||1|0|CITY_CENTER|1|0:WARRIOR:100|R/F|Râ-Kedet
...
66,30 1|p|||FARM||0||0|63:WARRIOR:52|R/A1/F|
67,30 1|ph|||MINE||0||0|||
68,30 1|co|||||||0|||
69,30 1|co|||||||0|||
70,30 0|co|||||||0|||
...
- per-query timing (s): meta=0.377, choices=0.36, cities=0.374, units=0.343, map=0.361, diplo=0.342, religion=0.343, notif=0.343
...
<!-- coach snapshot: schema=coach-snapshot/1.2 turn=95 generated_at=1785309460.2736008 failed_sections=none -->
