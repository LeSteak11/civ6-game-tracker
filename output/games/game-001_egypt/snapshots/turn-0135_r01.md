# CIV6 COACH SNAPSHOT — turn 135
_Egypt (Cleopatra) — 475 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## EMPIRE
- **score:** 138
- **gold:** 498 (net +9.3 = yield 22.3 − maint 13.0)
- **science:** 25.5/turn
- **culture:** 20.8/turn
- **faith:** 1204 (+27.5/turn)
- **tourism:** 20.0/turn
- **military:** 183
...
## RESEARCH / CIVIC
- **tech:** Celestial Navigation 91/120 (2t) — eureka:False [need: Improve 2 sea resources.]
- **civic:** Civil Service 96/275 (9t) — inspiration:False [need: Grow a city to 10 population.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Celestial Navigation  — 120sci (2t) — unlocks: Lighthouse, Great Lighthouse, Harbor, Royal Navy Dockyard — boost: Improve 2 sea resources.
...
- Civil Service  — 275cul (9t) — unlocks: Retainers, Meritocracy — inspiration: Grow a city to 10 population.
...
- **current:** Celestial Navigation — 91/120sci (2t)
...
- **current:** Civil Service — 96/275cul (9t)
...
## GREAT PEOPLE
- **GENERAL** 78pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
- **ADMIRAL** 0pts (+0.0/turn) — next recruit cost 120 — candidate: Leif Erikson
- **ENGINEER** 20pts (+2.4/turn) — next recruit cost 120 — candidate: Bi Sheng
- **MERCHANT** 0pts (+0.0/turn) — next recruit cost 60 — candidate: Zhang Qian
- **PROPHET** 124pts (+3.5/turn) — next recruit cost 240 — candidate: Martin Luther
- **SCIENTIST** 89pts (+2.4/turn) — next recruit cost 240 — candidate: Emilie du Chatelet
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 6 | grow - (food+0.0) | hous 12 | amen 4/2 | happ Happy | border+2t | growth +10%
- yields: F12.0 P30.5 G9.4 S10.7 C7.1 Fa12.6
- prod sources: tiles 18.0, bldgs 6, adj 1, other +5.5 (see JSON for all yields)
- **producing:** Settler (162/170, 1t)
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options (showing 10 of 25): Settler (1t), Scout (1t), Archer (2t), Trader (3t), Spearman (3t), Battering Ram (3t), Horseman (3t), Builder (4t), Catapult (4t), Siege Tower (4t)
...
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 27): Scout (5t), Archer (9t), Water Mill (9t), Spearman (10t), Battering Ram (10t), Trader (11t), Horseman (12t), Ancient Walls (12t), Builder (15t), Siege Tower (15t)
...
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - top production options (showing 10 of 25): Scout (4t), Archer (4t), Spearman (7t), Battering Ram (7t), Trader (8t), Horseman (9t), Builder (11t), Siege Tower (11t), Catapult (13t), Maryannu Chariot Archer (13t)
    - ...15 more options in JSON
    - unavailable (showing 6 of 48; full list + reasons in JSON):
        ...
        - Shrine — This building requires a Holy Site district.
### Luxis @ (64,22)
- pop 5 | grow 6t (food+5.0) | hous 8 | amen 2/2 | happ Content | border+19t
- yields: F15.0 P7.0 G8.0 S4.5 C3.5 Fa1.0
- prod sources: tiles 6.0, other +1.0 (see JSON for all yields)
- **producing:** Water Mill (41/80, 6t)
- defense: str 35 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 27): Scout (5t), Water Mill (6t), Archer (9t), Spearman (10t), Battering Ram (10t), Trader (11t), Horseman (12t), Ancient Walls (12t), Builder (15t), Siege Tower (15t)
    - ...17 more options in JSON
    - unavailable (showing 6 of 48; full list + reasons in JSON):
        - Great Library — Requires Library [reconstructed: BuildingPrereqs]
        - Stonehenge — blocked (reason not exposed by engine)
...
## UNITS (9)
- **Builder** #1900544 @(63,22) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch3
- **Scout** #1835009 @(73,10) | hp68/100 | mv3/3 | cs10 rs0 xp15/15 fort:2
...
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 176 mil 137 | met T27 | OB from them
...
69,14 1|g|||||||0|10:ARCHER:100|R/A4/F|
70,14 0|gm|||||||0||R/A4|
...
57,21 1|g|||||||0|8:WARRIOR:100|R/A2/F|
...
52,23 1|co|||||||0|||
53,23 1|g|||||||0||A2|
54,23 1|g||STONE|||8||0|8:BUILDER:100||
...
- per-query timing (s): meta=0.382, choices=0.358, cities=0.408, units=0.342, map=0.375, diplo=0.359, religion=0.341, notif=0.347
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=135 generated_at=1785315601.7467191 failed_sections=none counts: cities=4 units=9 tiles=657 majors=1 city_states=4 gossip=21 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=37926 -->
