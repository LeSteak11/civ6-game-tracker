# CIV6 COACH SNAPSHOT — turn 131
_Egypt (Cleopatra) — 375 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## EMPIRE
- **score:** 133
- **gold:** 460 (net +9.3 = yield 22.3 − maint 13.0)
- **science:** 24.8/turn
- **culture:** 20.5/turn
- **faith:** 1094 (+27.5/turn)
- **tourism:** 20.0/turn
- **military:** 183
- **techs / civics done:** 18 / 15
- **cities / units / pop:** 4 / 9 / 25
- **trade routes:** 1/1
...
## RESEARCH / CIVIC
- **tech:** Shipbuilding 191/200 (1t) — eureka:False [need: Own 2 Galleys.]
- **civic:** Civil Service 0/275 (13t) — inspiration:False [need: Grow a city to 10 population.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Shipbuilding  — 200sci (1t) — unlocks: Quadrireme, Colossus — boost: Own 2 Galleys.
- Celestial Navigation  — 120sci (5t) — unlocks: Lighthouse, Great Lighthouse, Harbor, Royal Navy Dockyard — boost: Improve 2 sea resources.
- Stirrups ★ — 390sci (8t) — unlocks: Knight, Mamluk
...
- Civil Service  — 275cul (13t) — unlocks: Retainers, Meritocracy — inspiration: Grow a city to 10 population.
...
- **current:** Shipbuilding — 191/200sci (1t)
...
- **current:** Civil Service — 0/275cul (13t)
...
## GREAT PEOPLE
- **GENERAL** 68pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
- **ADMIRAL** 0pts (+0.0/turn) — next recruit cost 120 — candidate: Leif Erikson
- **ENGINEER** 11pts (+2.4/turn) — next recruit cost 120 — candidate: Bi Sheng
- **MERCHANT** 0pts (+0.0/turn) — next recruit cost 60 — candidate: Zhang Qian
- **PROPHET** 110pts (+3.5/turn) — next recruit cost 240 — candidate: Martin Luther
- **SCIENTIST** 79pts (+2.4/turn) — next recruit cost 240 — candidate: Emilie du Chatelet
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 6 | grow 21t (food+2.0) | hous 12 | amen 4/2 | happ Happy | border+6t | growth +10%
- yields: F14.0 P31.6 G9.4 S10.7 C7.1 Fa12.6
- prod sources: tiles 18.0, bldgs 6, adj 1, trade 1, other +5.6 (see JSON for all yields)
- **producing:** Settler (37/170, 5t)
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options (showing 10 of 24): Scout (1t), Archer (2t), Trader (3t), Spearman (3t), Battering Ram (3t), Horseman (3t), Builder (4t), Catapult (4t), Siege Tower (4t), Maryannu Chariot Archer (4t)
    - ...14 more options in JSON
    - unavailable (showing 6 of 43; full list + reasons in JSON):
...
### Sais @ (62,26)
- pop 7 | grow 8t (food+8.0) | hous 7 | amen 3/3 | happ Content | border+4t
- yields: F22.0 P7.0 G2.0 S4.9 C4.1 Fa12.0
...
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 27): Granary (2t), Scout (5t), Archer (9t), Spearman (10t), Battering Ram (10t), Trader (11t), Horseman (12t), Ancient Walls (12t), Water Mill (12t), Builder (15t)
    - ...17 more options in JSON
    - unavailable (showing 6 of 45; full list + reasons in JSON):
        - Great Library — Requires Library [reconstructed: BuildingPrereqs]
...
### SHEDET @ (66,25)
- pop 7 | grow 7t (food+8.0) | hous 8 | amen 2/3 | happ Displeased | border+15t | growth -15%
- yields: F22.0 P8.6 G2.9 S4.7 C5.8 Fa1.9
- prod sources: tiles 8.0, other +0.6 (see JSON for all yields)
- **producing:** Water Mill (69/80, 2t)
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - tiles: 12 owned, 8 worked | terrain: 8 grass, 1 plains, 1 grass_hills, 1 coast, 1 grass_mountain | features: 1 marsh, 1 forest | improvements: 3 farm, 3 quarry, 2 sphinx
    - top production options (showing 10 of 25): Water Mill (2t), Scout (4t), Archer (8t), Spearman (8t), Battering Ram (8t), Trader (9t), Horseman (10t), Builder (12t), Siege Tower (12t), Catapult (15t)
    - ...15 more options in JSON
    - unavailable (showing 6 of 47; full list + reasons in JSON):
        - Great Library — Requires Library [reconstructed: BuildingPrereqs]
        - Stonehenge — blocked (reason not exposed by engine)
        - Hanging Gardens — blocked (reason not exposed by engine)
        - Pyramids — blocked (reason not exposed by engine)
        ...
        - Shrine — This building requires a Holy Site district.
### Luxis @ (64,22)
- pop 5 | grow 12t (food+4.0) | hous 7 | amen 2/2 | happ Content | border+3t
- yields: F14.0 P6.0 G8.0 S4.5 C3.5 Fa1.0
- prod sources: tiles 5.0, other +1.0 (see JSON for all yields)
- **producing:** Water Mill (16/80, 11t)
- defense: str 35 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - buildings in `CITY_CENTER`: Monument, Granary
    - tiles: 10 owned, 6 worked | terrain: 7 grass, 1 grass_mountain, 1 grass_hills, 1 plains | features: 2 forest, 1 jungle | improvements: 1 plantation
    - top production options (showing 10 of 26): Scout (5t), Archer (10t), Spearman (11t), Battering Ram (11t), Water Mill (11t), Trader (13t), Horseman (14t), Ancient Walls (14t), Builder (17t), Siege Tower (17t)
...
## UNITS (9)
- **Builder** #1900544 @(64,20) | hp100/100 | mv0/2 | cs0 rs0 xp0/15 ch4
- **Scout** #1835009 @(0,8) | hp100/100 | mv0/3 | cs10 rs0 xp12/15
- **Trader** #786434 @(64,28) | hp100/100 | mv0/2 | cs0 rs0 xp0/15
...
- **Man-At-Arms** #1769481 @(66,29) | hp100/100 | mv3/3 | cs45 rs0 xp15/45

## DIPLOMACY
- **envoys:** 0 in hand | 66/100 pts (+5.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 171 mil 160 | met T27 | OB from them
    - public: techs 24 | civics 14 | tourism 7
...
- Stockholm (city-state): 2 unit(s) — MAN_AT_ARMS, ARCHER
- Kabul (city-state): 2 unit(s) — 2× WARRIOR
- Hattusa (city-state): 2 unit(s) — 2× WARRIOR

## BARBARIANS (only what we can currently see)
- **units visible (4):** Galley @(1,9) hp75/100; Quadrireme @(0,6) hp100/100; Scout @(56,23) hp100/100; Galley @(0,7) hp100/100
...
- `NOTIFICATION_CIVIC_DISCOVERED`: Discovered Recorded History
- `NOTIFICATION_DISCOVER_NATURAL_WONDER`: Natural Wonder Discovered

## REVEALED MAP
_657 revealed, 201 currently visible, 2 natural wonders_
...
61,5 0|co|||||||0|||
62,5 0|co|||||||0|||
0,6 1|co||CRABS|||||0|63:QUADRIREME:100||
1,6 1|co||CRABS|||||0|||
55,6 0|sh|||||||0||A4|
56,6 0|sh|||||||0||A3|
59,6 0|co|||||||0|||
...
0,9 1|th|||||||0||A3|
1,9 1|co|||||||0|63:GALLEY:75||
2,9 0|co|||||||0|||
53,9 0|ph|||||||0||A1|
54,9 0|p||IVORY|||3||0||A3|
55,9 0|th|||||3||0||A4|
56,9 0|tm|||||3||0||A4|
57,9 0|ph|||||3||0||A2|
58,9 0|ph|||||3||0||A2|
...
66,14 1|d|||||||0||A-2|
67,14 1|d|fld||||||0|11:ARCHER:100|R/A2/F|
...
63,15 1|d||||1|||0||A1|
64,15 1|d|||||||0|||
65,15 1|dh||||1|||0|11:SWORDSMAN:100||
66,15 1|dh||SHEEP|||||0||A-1|
67,15 1|d|||||||0|10:ARCHER:100|A-1|
...
62,19 1|g||HORSES||1|||0|7:WARRIOR:100|A2|
63,19 1|gm|||||||0||A4|
...
64,20 1|g|for|DYES|PLANTATION||0||0|0:BUILDER:100|R/A2/F|
65,20 1|g||||1|||0||A2|
66,20 1|g||STONE||1|||0||A1|
67,20 1|g|||FARM|1|11||0|||
68,20 1|g|||FARM||11||0|11:SWORDSMAN:100|R/A1/F|
...
56,23 1|g|||FARM||8||0|63:SCOUT:100|R/A2/F|
57,23 1|gm|||||||0||A4|
...
55,25 1|p|||FARM||8||0|8:WARRIOR:100|A1|
...
52,26 1|oc|||||||0|||
53,26 1|co||FISH|||||0|||
54,26 1|p|for||||||0|8:WARRIOR:100|A3|
55,26 1|p|||||||0||A3|
...
- per-query timing (s): meta=0.395, choices=0.36, cities=0.406, units=0.344, map=0.377, diplo=0.374, religion=0.327, notif=0.345
- **failures at runtime:**
...
- compatibility notes (fallback paths, not failures):
    ...
    - `DIPLO.gossip`: gossip fetched via call arity 3 (20 entries)
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=131 generated_at=1785315230.277909 failed_sections=none counts: cities=4 units=9 tiles=657 majors=1 city_states=4 gossip=20 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=38163 -->
