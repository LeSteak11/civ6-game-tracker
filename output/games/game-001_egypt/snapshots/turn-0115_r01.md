# CIV6 COACH SNAPSHOT — turn 115
_Egypt (Cleopatra) — 25 BC / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.5.0_
...
## EMPIRE
- **score:** 119
- **gold:** 608 (net +9.2 = yield 17.2 − maint 8.0)
- **science:** 21.7/turn
- **culture:** 18.2/turn
- **faith:** 703 (+22.2/turn)
- **tourism:** 20.0/turn
...
- **civic:** Feudalism 157/275 (7t) — inspiration:True
...
- Feudalism ★ — 275cul (7t) — unlocks: Feudal Contract, Serfdom
- Recorded History  — 175cul (10t) — unlocks: Natural Philosophy — inspiration: Build 2 Campus districts.
- Naval Tradition  — 200cul (12t) — unlocks: Naval Infrastructure, Navigation — inspiration: Kill a unit with a Quadrireme.
...
- **current:** Feudalism — 157/275cul (7t)
...
## GREAT PEOPLE
- **GENERAL** 30pts (+2.3/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 62pts (+2.3/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 60pts (+2.3/turn) — next recruit cost 120 — candidate: Omar Khayyam
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 4 | grow 12t (food+2.0) | hous 12 | amen 3/1 | happ Happy | border+2t | growth +10%
- yields: F10.0 P20.5 G9.4 S9.2 C6.5 Fa12.6
- prod sources: tiles 13.0, bldgs 4, trade 1, other +2.5 (see JSON for all yields)
...
- majority religion: RELIGION_TAOISM
    ...
    - tiles: 16 owned, 5 worked | terrain: 9 plains, 5 plains_hills, 1 grass, 1 grass_hills | features: 1 marsh | improvements: 5 farm, 3 mine, 2 sphinx, 1 camp
    - top production options: Scout (1t), Archer (2t), Trader (3t), Spearman (3t), Battering Ram (3t), Horseman (3t), Builder (4t), Siege Tower (4t), Catapult (5t), Maryannu Chariot Archer (5t)
    - ...14 more options in JSON
    - trade → Sais (domestic): Food +2, Production +1
### Sais @ (62,26)
- pop 7 | grow 25t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+20t | growth -15%
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa7.6
- prod sources: tiles 6.0, other +0.7 (see JSON for all yields)
- **producing:** Temple (67/120, 8t)
- defense: str 27 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (5t), Temple (8t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Trader (11t), Horseman (13t), Ancient Walls (13t), Water Mill (13t)
    - ...18 more options in JSON
### SHEDET @ (66,25)
- pop 6 | grow 1t (food+7.0) | hous 8 | amen 1/2 | happ Displeased | border+1t | growth -15%
- yields: F19.0 P8.6 G2.9 S4.0 C4.6 Fa1.0
- prod sources: tiles 8.0, other +0.6 (see JSON for all yields)
- **producing:** Builder (49/90, 5t)
- defense: str 28 | garrison 200/200 | walls 100/100
    ...
    - top production options: Scout (4t), Builder (5t), Archer (8t), Spearman (8t), Battering Ram (8t), Trader (9t), Horseman (10t), Water Mill (10t), Siege Tower (12t), Aqueduct (14t)
    - ...15 more options in JSON
### Luxis @ (64,22)
- pop 4 | grow 11t (food+4.0) | hous 7 | amen 1/1 | happ Content | border+3t
- yields: F12.0 P5.0 G3.0 S3.8 C3.2 Fa1.0
- prod sources: tiles 4.0, other +1.0 (see JSON for all yields)
- **producing:** Builder (18/90, 15t)
- defense: str 25 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - buildings in `CITY_CENTER`: Monument, Granary
    - tiles: 9 owned, 5 worked | terrain: 6 grass, 1 grass_mountain, 1 grass_hills, 1 plains | features: 1 forest, 1 jungle
    - top production options: Scout (6t), Archer (12t), Spearman (13t), Battering Ram (13t), Trader (14t), Builder (15t), Horseman (16t), Ancient Walls (16t), Water Mill (16t), Siege Tower (20t)
    - ...16 more options in JSON

## UNITS (9)
- **Scout** #196608 @(66,27) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
- **Builder** #1572865 @(67,30) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch2 <IDLE>
- **Trader** #786434 @(63,27) | hp100/100 | mv2/2 | cs0 rs0 xp0/15
- **Warrior** #655363 @(62,26) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 fort:2
- **Spearman** #1638404 @(65,26) | hp100/100 | mv2/2 | cs25 rs0 xp0/15 <IDLE>
- **Great General** #1310725 @(66,29) | hp100/100 | mv4/4 | cs0 rs0 xp0/15
- **Archer** #1048582 @(66,30) | hp100/100 | mv2/2 | cs15 rs25 xp25/45 <IDLE>
...
## DIPLOMACY
- **envoys:** 0 in hand | 92/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 147 mil 171 | met T27 | OB from them
...
- `NOTIFICATION_TECH_DISCOVERED`: Discovered Apprenticeship
...
## REVEALED MAP
_617 revealed, 133 currently visible, 1 natural wonders_
...
66,14 1|d|||||||0|11:SWORDSMAN:100|A-2|
...
65,19 1|g|||||||0||A1|
66,19 1|g|||FARM||11||0|||
67,19 1|p||||1|11|CITY_CENTER|1|11:ARCHER:100|R/A2/F|Amsterdam
...
65,26 1|gh||||1|0|ENCAMPMENT|0|0:SPEARMAN:100|A-1|
...
66,27 1|p||||1|0|WONDER|0|0:SCOUT:100|R/F|
...
66,30 1|p|||FARM||0||0|0:ARCHER:100|R/A1/F|
67,30 1|ph|||MINE||0||0|0:BUILDER:100||
68,30 1|co|||||||0|||
69,30 1|co|||||||0|||
70,30 0|co|||||||0|||
61,31 0|oc|||||||0|||
...
- per-query timing (s): meta=0.368, choices=0.36, cities=0.39, units=0.34, map=0.362, diplo=0.358, religion=0.344, notif=0.346
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=115 generated_at=1785313321.1385791 failed_sections=none -->
