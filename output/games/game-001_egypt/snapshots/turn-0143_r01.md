# CIV6 COACH SNAPSHOT — turn 143
_Egypt (Cleopatra) — 640 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.7.0_
...
## RESEARCH / CIVIC
- **tech:** Stirrups 373/390 (1t) — eureka:True
- **civic:** Mercenaries 229/290 (3t) — inspiration:True

### TECHS AVAILABLE (up to 10, sorted by turns)
- Stirrups ★ — 390sci (1t) — unlocks: Knight, Mamluk
...
- Mercenaries ★ — 290cul (3t) — unlocks: Sack, Professional Army, Trade Confederation
...
- **current:** Stirrups — 373/390sci (1t)
...
- **current:** Mercenaries — 229/290cul (3t)
...
## GREAT PEOPLE
- **GENERAL** 97pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
- **ADMIRAL** 0pts (+0.0/turn) — next recruit cost 240 — candidate: Yi Sun-sin
- **ENGINEER** 39pts (+2.4/turn) — next recruit cost 120 — candidate: Bi Sheng
- **MERCHANT** 0pts (+0.0/turn) — next recruit cost 60 — candidate: Zhang Qian
- **PROPHET** 152pts (+3.6/turn) — next recruit cost 2147483647
- **SCIENTIST** 108pts (+2.4/turn) — next recruit cost 240 — candidate: Emilie du Chatelet
...
## CITIES (5)
### Râ-Kedet [CAP] @ (66,29)
- pop 5 | grow 26t (food+1.0) | hous 12 | amen 3/2 (+1; +2 amen → Ecstatic) | happ Happy | border+18t | growth +10%
...
- majority religion: RELIGION_TAOISM
    ...
    - can build now (26 options; cost⚙, turns):
        ...
        - units (showing 8 of 12 by turns; rest in JSON): Builder (98⚙ 2t) [60/98 banked], Scout (30⚙ 2t), Trader (74⚙ 3t), Archer (60⚙ 3t), Spearman (65⚙ 3t), Battering Ram (65⚙ 3t), Horseman (80⚙ 4t), Siege Tower (100⚙ 4t)
...
### Sais @ (62,26)
- pop 8 | grow 10t (food+9.0) | hous 9 | amen 3/3 (+0; +1 amen → Happy) | happ Content | border+18t
...
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - can build now (28 options; cost⚙, turns):
        ...
        - buildings: Water Mill (80⚙ 2t) [71/80 banked], Ancient Walls (80⚙ 14t)
...
### SHEDET @ (66,25)
- pop 8 | grow 26t (food+13.0) | hous 8 | amen 2/3 (-1; +1 amen → Content) | happ Displeased | border+2t | growth -15%
- districts: 1/3 built — 2 slot(s) OPEN [pop/3+1]
...
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - can build now (26 options; cost⚙, turns):
        - districts (need placement): Aqueduct (129⚙ 17t), Campus (194⚙ 18t) [41/194 banked], Holy Site (194⚙ 26t), Encampment (194⚙ 26t), Harbor (194⚙ 26t), Commercial Hub (194⚙ 26t), Entertainment Complex (194⚙ 26t), Theater Square (194⚙ 26t), Industrial Zone (194⚙ 26t)
    ...
    - unavailable (showing 6 of 50; full list + reasons in JSON):
        ...
        - Oracle — blocked (reason not exposed by engine)
### Luxis @ (64,22)
- pop 6 | grow 6t (food+8.0) | hous 8 | amen 2/2 (+0; +1 amen → Happy) | happ Content | border+10t
...
- **producing:** Ancient Walls (30/80, 6t)
- defense: str 35 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - buildings in `CITY_CENTER`: Monument, Granary, Water Mill
    - tiles: 11 owned, 7 worked | terrain: 7 grass, 1 plains, 1 grass_mountain, 1 grass_hills, 1 plains_hills | features: 2 jungle, 2 forest | improvements: 2 farm, 1 plantation, 1 mine
    - can build now (27 options; cost⚙, turns):
        ...
        - buildings: Ancient Walls (80⚙ 6t) [30/80 banked]
    ...
    - unavailable (showing 6 of 50; full list + reasons in JSON):
        ...
        - Oracle — blocked (reason not exposed by engine)
### ASRUS @ (68,35)
- pop 1 | grow 6t (food+2.0) | hous 3 | amen 1/0 (+1; +2 amen → Ecstatic) | happ Happy | border+32t | growth +10%
...
- defense: str 45 | garrison 200/200 | walls 0/0
    ...
    - can build now (31 options; cost⚙, turns):
        - districts (need placement): Aqueduct (129⚙ 41t), Holy Site (194⚙ 62t), Campus (194⚙ 62t), Encampment (194⚙ 62t), Harbor (194⚙ 62t), Commercial Hub (194⚙ 62t), Entertainment Complex (194⚙ 62t), Theater Square (194⚙ 62t), Industrial Zone (194⚙ 62t)
        ...
        - buildings: Monument (60⚙ 20t), Granary (65⚙ 20t) [3/65 banked], Ancient Walls (80⚙ 26t)
        - units (showing 8 of 14 by turns; rest in JSON): Scout (30⚙ 10t), Archer (60⚙ 20t), Galley (65⚙ 21t), Spearman (65⚙ 21t), Battering Ram (65⚙ 21t), Trader (74⚙ 24t), Horseman (80⚙ 26t), Builder (98⚙ 32t)
...
- **Scout** #1835009 @(70,8) | hp100/100 | mv3/3 | cs10 rs0 xp15/45 <IDLE>
...
- **Horseman** #2162700 @(67,35) | hp100/100 | mv4/4 | cs36 rs0 xp0/15 <IDLE>

## DIPLOMACY
- **envoys:** 0 in hand | 26/100 pts (+5.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 182 mil 147 | met T27
...
- **units visible (1):** Scout @(56,22) hp100/100
...
## REVEALED MAP
_677 revealed, 207 currently visible, 2 natural wonders_
...
68,8 1|gh|||||||0||A2|
69,8 1|g|mar||||||0||A3|
70,8 1|gh||COPPER|||||0|0:SCOUT:100||
71,8 1|th|||||||0|||
72,8 1|t|for||||||0||A4/F|
...
- per-query timing (s): meta=0.368, choices=0.357, cities=0.391, units=0.341, map=0.377, diplo=0.355, religion=0.341, notif=0.342
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=143 generated_at=1785399779.0065656 failed_sections=none counts: cities=5 units=12 tiles=677 majors=1 city_states=4 gossip=22 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=43445 -->
