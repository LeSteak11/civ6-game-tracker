# CIV6 COACH SNAPSHOT — turn 110
_Egypt (Cleopatra) — 150 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.5.0_
...
## EMPIRE
- **score:** 117
- **gold:** 557 (net +10.2 = yield 17.2 − maint 7.0)
- **science:** 21.0/turn
- **culture:** 17.9/turn
- **faith:** 592 (+22.2/turn)
- **tourism:** 19.0/turn
...
## RESEARCH / CIVIC
- **tech:** Apprenticeship 195/300 (5t) — eureka:True
- **civic:** Defensive Tactics 107/175 (4t) — inspiration:False [need: Be the target of a Declaration of War.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Apprenticeship ★ — 300sci (5t) — unlocks: Man-At-Arms, Workshop, Industrial Zone, Hansa
...
- Defensive Tactics  — 175cul (4t) — unlocks: Bastions, Limes — inspiration: Be the target of a Declaration of War.
...
- **current:** Apprenticeship — 195/300sci (5t)
...
- **current:** Defensive Tactics — 107/175cul (4t)
...
## GREAT PEOPLE
- **GENERAL** 19pts (+2.3/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 51pts (+2.3/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 49pts (+2.3/turn) — next recruit cost 120 — candidate: Omar Khayyam
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options: Builder (1t), Scout (2t), Archer (3t), Trader (4t), Spearman (4t), Battering Ram (4t), Horseman (4t), Swordsman (5t), Siege Tower (5t), Catapult (6t)
    - ...13 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 7 | grow 30t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+1t | growth -15%
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa7.6
- prod sources: tiles 6.0, other +0.7 (see JSON for all yields)
- **producing:** Temple (34/120, 13t)
- defense: str 27 | garrison 200/200 | walls 0/0
    ...
    - tiles: 12 owned, 8 worked | terrain: 8 grass, 2 plains, 1 grass_hills, 1 plains_hills | features: 2 jungle, 1 marsh | improvements: 2 pasture, 1 farm, 1 plantation
...
### SHEDET @ (66,25)
- pop 6 | grow 6t (food+7.0) | hous 8 | amen 1/2 | happ Displeased | border+6t | growth -15%
...
- defense: str 28 | garrison 200/200 | walls 100/100
    ...
    - top production options: Scout (3t), Archer (7t), Spearman (7t), Battering Ram (7t), Trader (8t), Horseman (9t), Water Mill (9t), Builder (10t), Swordsman (10t), Siege Tower (11t)
    - ...14 more options in JSON
### Luxis @ (64,22)
- pop 3 | grow 7t (food+2.0) | hous 5 | amen 1/1 | happ Content | border+8t
- yields: F8.0 P5.0 G3.0 S3.1 C2.9 Fa1.0
- prod sources: tiles 4.0, other +1.0 (see JSON for all yields)
- **producing:** Granary (58/65, 2t)
- defense: str 25 | garrison 200/200 | walls 0/0
    ...
    - top production options: Granary (2t), Scout (6t), Archer (12t), Spearman (13t), Battering Ram (13t), Trader (14t), Horseman (16t), Ancient Walls (16t), Water Mill (16t), Builder (18t)
    - ...16 more options in JSON

## UNITS (7)
- **Scout** #196608 @(61,14) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
...
- **Swordsman** #1507336 @(66,29) | hp77/100 | mv3/3 | cs35 rs0 xp15/15

## DIPLOMACY
- **envoys:** 0 in hand | 77/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 142 mil 162 | met T27 | OB from them
    - public: techs 21 | civics 12 | tourism 4
    - known cities (6): Uruk★?, Lagash?, Rio de Janeiro?, Adab p4, Recife?, Kish?
...
## REVEALED MAP
_617 revealed, 153 currently visible, 1 natural wonders_
...
60,12 1|g||||1|3|CITY_CENTER|1||R/A1/F|Adab
...
59,14 1|g|||||3||0||R/A3/F|
60,14 1|g|||||3||0|||
61,14 1|g|||||||0|0:SCOUT:100||
62,14 1|dh|||||||0||A1|
63,14 1|dm|||||||0||A4|
...
69,15 1|p|for||||||0|11:ARCHER:100|R/A3/F|
...
67,18 1|g|||FARM|1|11||0|11:WARRIOR:100||
...
65,19 1|g|||||||0||A1|
66,19 1|g|||FARM||11||0|||
67,19 1|p||||1|11|CITY_CENTER|1|11:WARRIOR:100|R/A2/F|Amsterdam
...
66,29 1|ph||||1|0|CITY_CENTER|1|0:GREAT_GENERAL:100;0:SWORDSMAN:77|R/F|Râ-Kedet
...
- per-query timing (s): meta=0.367, choices=0.359, cities=0.375, units=0.345, map=0.363, diplo=0.358, religion=0.342, notif=0.344
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=110 generated_at=1785312272.0415087 failed_sections=none -->
