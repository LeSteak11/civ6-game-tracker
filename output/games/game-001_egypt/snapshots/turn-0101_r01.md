# CIV6 COACH SNAPSHOT — turn 101
_Egypt (Cleopatra) — 375 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.3 coach 1.3.0_
...
## RESEARCH / CIVIC
- **tech:** Engineering 150/200 (3t) — eureka:False [need: Build Ancient Walls.]
- **civic:** Military Training 85/120 (3t) — inspiration:True

### TECHS AVAILABLE (up to 10, sorted by turns)
- Engineering  — 200sci (3t) — unlocks: Catapult, Aqueduct, Bath — boost: Build Ancient Walls.
...
- Military Training ★ — 120cul (3t) — unlocks: Raid, Veterancy
...
- **current:** Engineering — 150/200sci (3t)
...
- **current:** Military Training — 85/120cul (3t)
...
## GREAT PEOPLE
- **GENERAL** 5pts (+1.2/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 35pts (+1.2/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 28pts (+2.3/turn) — next recruit cost 120 — candidate: Omar Khayyam
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 2t (food+2.0) | hous 10 | amen 3/1 | happ 5 | border+17t
- yields: F8.0 P13.9 G9.4 S8.5 C6.2 Fa12.6
- **producing:** Ancient Walls (19/80, 5t)
...
- majority religion: RELIGION_TAOISM
    ...
    - tiles: 16 owned, 4 worked | terrain: 9 plains, 5 plains_hills, 1 grass, 1 grass_hills | features: 1 marsh, 1 forest | improvements: 3 farm, 2 mine, 2 sphinx, 1 camp
    - top production options: Scout (2t), Warrior (3t), Archer (4t), Trader (5t), Spearman (5t), Battering Ram (5t), Horseman (5t), Ancient Walls (5t), Builder (6t), Siege Tower (7t)
    - ...14 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 7 | grow 39t (food+8.0) | hous 7 | amen 2/3 | happ 3 | border+10t
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa5.7
- **producing:** Shrine (44/70, 4t)
- defense: str 22 | garrison 200/200 | walls 0/0
    ...
    - top production options: Shrine (4t), Scout (5t), Warrior (7t), Trader (10t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Builder (13t), Horseman (13t)
    - ...16 more options in JSON
### SHEDET @ (66,25)
- pop 5 | grow 4t (food+6.0) | hous 7 | amen 1/2 | happ 3 | border+21t
- yields: F16.0 P7.6 G2.9 S3.3 C2.4 Fa1.0
- **producing:** Ancient Walls (15/80, 9t)
- defense: str 20 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (66,25)
    - buildings in `CITY_CENTER`: Granary
    - tiles: 10 owned, 6 worked | terrain: 7 grass, 1 plains, 1 coast, 1 grass_hills | features: 2 forest, 1 marsh | improvements: 2 quarry, 1 sphinx, 1 farm
    - top production options: Scout (4t), Warrior (6t), Archer (8t), Monument (8t), Trader (9t), Spearman (9t), Battering Ram (9t), Ancient Walls (9t), Horseman (11t), Water Mill (11t)
    - ...14 more options in JSON
### Luxis @ (64,22)
- pop 3 | grow 16t (food+2.0) | hous 5 | amen 1/1 | happ 4 | border+5t
- yields: F8.0 P5.0 G3.0 S3.1 C2.9 Fa1.0
- **producing:** Granary (13/65, 11t)
- defense: str 10 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (6t), Warrior (8t), Granary (11t), Archer (12t), Trader (13t), Spearman (13t), Battering Ram (13t), Horseman (16t), Ancient Walls (16t), Water Mill (16t)
    - ...14 more options in JSON

## UNITS (9)
- **Scout** #196608 @(52,22) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
...
- **Builder** #1376260 @(67,25) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch3 <IDLE>
...
- **Builder** #1441800 @(64,29) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch3 <IDLE>

## DIPLOMACY
- **envoys:** 0 in hand | 50/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 130 mil 136 | met T27
...
## REVEALED MAP
_591 revealed, 146 currently visible, 1 natural wonders_
...
56,23 1|g|||FARM||8||0|8:BUILDER:100|R/A2/F|
57,23 1|gm|||||||0||A4|
...
67,25 1|g|for||||0||0|0:BUILDER:100|A2|
68,25 1|co||FISH|||0||0|||
69,25 1|co||FISH|||||0|||
52,26 0|oc|||||||0|||
53,26 1|co||FISH|||||0|||
...
64,29 1|p||||1|0||0|0:BUILDER:100|A2|
...
- per-query timing (s): meta=0.366, choices=0.359, cities=0.374, units=0.343, map=0.361, diplo=0.356, religion=0.343, notif=0.329
...
<!-- coach snapshot: schema=coach-snapshot/1.3 turn=101 generated_at=1785310882.2646375 failed_sections=none -->
