...
## RESEARCH / CIVIC
- **tech:** Shipbuilding 0/200 (9t) — eureka:False [need: Own 2 Galleys.]
...
- **current:** Shipbuilding — 0/200sci (9t)
...
## UNITS (9)
- **Builder** #1703936 @(67,24) | hp100/100 | mv1/2 | cs0 rs0 xp0/15 ch2 <IDLE>
- **Scout** #1835009 @(67,22) | hp100/100 | mv0/3 | cs10 rs0 xp0/15
...
- per-query timing (s): meta=0.379, choices=0.374, cities=0.394, units=0.356, map=0.36, diplo=0.36, religion=0.346, notif=0.343
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=123 generated_at=1785314512.1365452 failed_sections=none counts: cities=4 units=9 tiles=626 majors=1 city_states=4 gossip=19 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=36819 -->
