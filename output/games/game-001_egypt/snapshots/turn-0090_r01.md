# CIV6 COACH SNAPSHOT — turn 90
_Egypt (Cleopatra) — 650 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.2 coach 1.2.1_
...
## EMPIRE
- **score:** 92
- **gold:** 368 (net +13.6 = yield 15.6 − maint 2.0)
- **science:** 17.8/turn
- **culture:** 12.6/turn
- **faith:** 220 (+14.6/turn)
- **tourism:** 19.0/turn
...
## RESEARCH / CIVIC
- **tech:** Construction 144/200 (4t) — eureka:False [need: Build a Water Mill.]
- **civic:** Military Tradition 43/50 (1t) — inspiration:False [need: Clear a Barbarian Outpost.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Construction  — 200sci (4t) — unlocks: Siege Tower, Terracotta Army — boost: Build a Water Mill.
...
- Military Tradition  — 50cul (1t) — unlocks: Maneuver, Strategos — inspiration: Clear a Barbarian Outpost.
...
- **current:** Construction — 144/200sci (4t)
...
- **current:** Military Tradition — 43/50cul (1t)
...
## GREAT PEOPLE
- **GENERAL** 52pts (+1.1/turn) — next recruit cost 60 — candidate: Sun Tzu
...
- **SCIENTIST** 2pts (+2.3/turn) — next recruit cost 120 — candidate: Abu al-Qasim al-Zahrawi
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 21t (food+1.0) | hous 10 | amen 3/1 | happ 5 | border+9t
- yields: F7.0 P12.8 G10.5 S8.5 C6.2 Fa13.6
- **producing:** Water Mill (25/80, 5t)
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options: Scout (3t), Warrior (3t), Trader (5t), Archer (5t), Spearman (5t), Battering Ram (5t), Water Mill (5t), Builder (6t), Horseman (6t), Ancient Walls (7t)
    - ...12 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 6 | grow 4t (food+8.0) | hous 7 | amen 1/2 | happ 3 | border+3t
- yields: F20.0 P6.7 G1.9 S4.0 C3.6 Fa0.0
- **producing:** Holy Site (102/131, 5t)
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (5t), Holy Site (5t), Warrior (7t), Trader (10t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Builder (12t), Horseman (13t)
    - ...11 more options in JSON
### SHEDET @ (66,25)
- pop 4 | grow 2t (food+5.0) | hous 5 | amen 1/1 | happ 4 | border+11t
- yields: F13.0 P6.0 G0.0 S2.8 C2.2 Fa1.0
- **producing:** Granary (36/65, 5t)
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (5t), Granary (5t), Builder (6t), Warrior (7t), Archer (10t), Monument (10t), Trader (11t), Spearman (11t), Battering Ram (11t), Horseman (14t)
    - ...12 more options in JSON
### Luxis @ (64,22)
- pop 2 | grow 10t (food+2.0) | hous 5 | amen 1/0 | happ 5 | border+12t
- yields: F6.0 P4.2 G3.1 S2.5 C0.6 Fa0.0
- **producing:** Monument (26/60, 9t)
- defense: str 10 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (8t), Monument (9t), Warrior (10t), Trader (15t), Archer (15t), Spearman (16t), Battering Ram (16t), Granary (16t), Builder (19t), Horseman (20t)
    - ...12 more options in JSON

## UNITS (6)
- **Scout** #196608 @(49,21) | hp58/100 | mv3/3 | cs10 rs0 xp16/45 <IDLE>
- **Warrior** #131073 @(66,29) | hp100/100 | mv2/2 | cs20 rs0 xp7/15 fort:2
- **Trader** #786434 @(64,22) | hp100/100 | mv2/2 | cs0 rs0 xp0/15
...
## DIPLOMACY
- **envoys:** 0 in hand | 17/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 100 mil 149 | met T27 | OB from them
- **Brazil (Pedro II)** — DIPLO_STATE_FRIENDLY | vis 0 | score 34 mil 12 | met T84
### CITY-STATES MET
...
- **units visible (1):** Galley @(68,26) hp72/100
...
60,21 0|g|||||||0||A1|
61,21 0|g|||||||0||A-2|
62,21 1|g||RICE|||||0|7:WARRIOR:100|A-1|
...
- per-query timing (s): meta=0.38, choices=0.361, cities=0.374, units=0.342, map=0.376, diplo=0.342, religion=0.343, notif=0.344
...
<!-- coach snapshot: schema=coach-snapshot/1.2 turn=90 generated_at=1785308471.3635602 failed_sections=none -->
