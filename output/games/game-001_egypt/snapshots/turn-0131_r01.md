...
- turns elapsed: 1
- empire: gold: -98.10000000000002, faith: +26.799999999999955, military: -8, civics_done: +1, explored_land: +3
- newly revealed tiles: 7 (sample: (0,9) th, (1,9) co, (73,9) th, (0,10) g, (1,10) co, (2,10) co, (2,11) co)
- units moved: 3
- resources: RESOURCE_HORSES+2, RESOURCE_CRABS+1, RESOURCE_IRON+1
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 6 | grow 21t (food+2.0) | hous 12 | amen 3/2 | happ Happy | border+6t | growth +10%
...
### Sais @ (62,26)
- pop 7 | grow 9t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+4t | growth -15%
...
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 27): Granary (2t), Scout (5t), Archer (10t), Spearman (10t), Battering Ram (10t), Trader (12t), Horseman (13t), Ancient Walls (13t), Water Mill (13t), Builder (15t)
...
### SHEDET @ (66,25)
- pop 7 | grow 7t (food+8.0) | hous 8 | amen 1/3 | happ Displeased | border+15t | growth -15%
...
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - unavailable (showing 6 of 47; full list + reasons in JSON):
        ...
        - Shrine — This building requires a Holy Site district.
### Luxis @ (64,22)
- pop 5 | grow 14t (food+4.0) | hous 7 | amen 1/2 | happ Displeased | border+3t | growth -15%
- yields: F14.0 P5.7 G5.7 S4.3 C3.3 Fa1.0
- prod sources: tiles 5.0, other +0.7 (see JSON for all yields)
- **producing:** Water Mill (16/80, 12t)
- defense: str 35 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 26): Scout (6t), Archer (11t), Spearman (12t), Battering Ram (12t), Water Mill (12t), Trader (13t), Horseman (15t), Ancient Walls (15t), Builder (18t), Siege Tower (18t)
...
## UNITS (9)
- **Builder** #1900544 @(64,20) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch5 <IDLE>
- **Scout** #1835009 @(0,10) | hp100/100 | mv3/3 | cs10 rs0 xp0/15
...
- **units visible (2):** Galley @(1,9) hp75/100; Scout @(56,23) hp100/100
...
## REVEALED MAP
_645 revealed, 200 currently visible, 1 natural wonders_
...
64,20 1|g|for|DYES|||0||0|0:BUILDER:100|R/A2/F|
65,20 1|g||||1|||0||A2|
...
- per-query timing (s): meta=0.377, choices=0.361, cities=0.393, units=0.345, map=0.365, diplo=0.361, religion=0.342, notif=0.343
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=131 generated_at=1785315099.7294157 failed_sections=none counts: cities=4 units=9 tiles=645 majors=1 city_states=4 gossip=20 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=37959 -->
