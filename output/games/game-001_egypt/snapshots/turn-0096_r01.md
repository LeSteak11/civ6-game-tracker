# CIV6 COACH SNAPSHOT — turn 96
_Egypt (Cleopatra) — 500 BC / Classical Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.2 coach 1.2.1_

## CHANGES SINCE LAST SNAPSHOT
- turns elapsed: 1
- empire: score: +5, gold: +12.599999999999966, faith: +17.5, military: -3
- units moved: 2
...
## EMPIRE
- **score:** 103
- **gold:** 448 (net +12.6 = yield 15.6 − maint 3.0)
- **science:** 19.0/turn
- **culture:** 13.1/turn
- **faith:** 311 (+17.5/turn)
- **tourism:** 19.0/turn
...
## RESEARCH / CIVIC
- **tech:** Engineering 55/200 (8t) — eureka:False [need: Build Ancient Walls.]
- **civic:** Theology 75/120 (4t) — inspiration:True
...
- Engineering  — 200sci (8t) — unlocks: Catapult, Aqueduct, Bath — boost: Build Ancient Walls.
...
- Theology ★ — 120cul (4t) — unlocks: Scripture
...
- **current:** Engineering — 55/200sci (8t)
...
## GREAT PEOPLE
- **GENERAL** 59pts (+1.2/turn) — next recruit cost 60 — candidate: Sun Tzu
...
- **PROPHET** 29pts (+1.2/turn) — next recruit cost 120 — candidate: Bodhidharma
- **SCIENTIST** 16pts (+2.3/turn) — next recruit cost 120 — candidate: Abu al-Qasim al-Zahrawi
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 3 | grow 7t (food+2.0) | hous 10 | amen 3/1 | happ 5 | border+3t
- yields: F8.0 P16.0 G10.5 S8.5 C6.2 Fa13.6
- **producing:** Builder (25/78, 4t)
- defense: str 15 | garrison 200/200 | walls 0/0
- majority religion: RELIGION_TAOISM
    ...
    - top production options: Scout (2t), Warrior (3t), Builder (4t), Trader (4t), Archer (4t), Spearman (5t), Battering Ram (5t), Horseman (5t), Ancient Walls (6t), Siege Tower (7t)
    - ...13 more options in JSON
    - trade → Luxis (domestic): Food +1, Production +1
### Sais @ (62,26)
- pop 7 | grow 44t (food+8.0) | hous 7 | amen 2/3 | happ 3 | border+15t
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa2.9
- **producing:** Shrine (11/70, 9t)
- defense: str 22 | garrison 200/200 | walls 0/0
    ...
    - top production options: Scout (5t), Warrior (7t), Shrine (9t), Trader (10t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Builder (12t), Horseman (13t)
    - ...14 more options in JSON
### SHEDET @ (66,25)
- pop 5 | grow 9t (food+6.0) | hous 7 | amen 1/2 | happ 3 | border+4t
- yields: F16.0 P7.6 G0.0 S3.3 C2.4 Fa1.0
- **producing:** Builder (55/78, 3t)
- defense: str 20 | garrison 200/200 | walls 0/0
    ...
    - top production options: Builder (3t), Scout (4t), Warrior (6t), Archer (8t), Monument (8t), Trader (9t), Spearman (9t), Battering Ram (9t), Horseman (11t), Ancient Walls (11t)
    - ...13 more options in JSON
### Luxis @ (64,22)
- pop 2 | grow 4t (food+2.0) | hous 5 | amen 1/0 | happ 5 | border+6t
- yields: F6.0 P4.2 G3.1 S2.5 C0.6 Fa0.0
- **producing:** Monument (51/60, 3t)
- defense: str 10 | garrison 200/200 | walls 0/0
    ...
    - top production options: Monument (3t), Scout (8t), Warrior (10t), Archer (15t), Trader (16t), Spearman (16t), Battering Ram (16t), Granary (16t), Builder (19t), Horseman (20t)
    - ...14 more options in JSON

## UNITS (6)
- **Scout** #196608 @(48,23) | hp100/100 | mv3/3 | cs10 rs0 xp16/45
- **Warrior** #131073 @(66,30) | hp83/100 | mv2/2 | cs20 rs0 xp14/15 <IDLE>
- **Trader** #786434 @(66,28) | hp100/100 | mv2/2 | cs0 rs0 xp0/15
- **Warrior** #655363 @(62,26) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 fort:2
- **Archer** #1048582 @(67,29) | hp100/100 | mv2/2 | cs15 rs25 xp24/45 <IDLE>
- **Warrior** #983047 @(66,25) | hp100/100 | mv2/2 | cs20 rs0 xp0/15 fort:2

## DIPLOMACY
- **envoys:** 0 in hand | 35/100 pts (+3.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 114 mil 165 | met T27 | OB from them
### CITY-STATES MET
...
- **units visible (2):** Quadrireme @(47,23) hp100/100; Galley @(48,24) hp100/100
...
## REVEALED MAP
_538 revealed, 109 currently visible, 1 natural wonders_
...
71,22 0|co|||||||0|||
46,23 1|co||CRABS|||||0|||
47,23 1|co|||||||0|63:QUADRIREME:100||
...
66,29 1|ph||||1|0|CITY_CENTER|1||R/F|Râ-Kedet
...
66,30 1|p|||FARM||0||0|0:WARRIOR:83|R/A1/F|
67,30 1|ph|||MINE||0||0|||
68,30 1|co|||||||0|||
69,30 1|co|||||||0|||
70,30 0|co|||||||0|||
...
- per-query timing (s): meta=0.373, choices=0.376, cities=0.374, units=0.346, map=0.365, diplo=0.34, religion=0.343, notif=0.345
...
<!-- coach snapshot: schema=coach-snapshot/1.2 turn=96 generated_at=1785309712.9644544 failed_sections=none -->
