# CIV6 COACH SNAPSHOT — turn 121
_Egypt (Cleopatra) — 125 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## EMPIRE
- **score:** 123
- **gold:** 592 (net +6.4 = yield 14.4 − maint 8.0)
- **science:** 22.3/turn
- **culture:** 18.4/turn
- **faith:** 836 (+22.2/turn)
- **tourism:** 20.0/turn
...
## RESEARCH / CIVIC
- **tech:** Mathematics 133/200 (3t) — eureka:False [need: Build 3 different specialty districts.]
- **civic:** Feudalism 267/275 (1t) — inspiration:True

### TECHS AVAILABLE (up to 10, sorted by turns)
- Mathematics  — 200sci (3t) — unlocks: Petra — boost: Build 3 different specialty districts.
...
- Feudalism ★ — 275cul (1t) — unlocks: Feudal Contract, Serfdom
...
- **current:** Mathematics — 133/200sci (3t)
...
- **current:** Feudalism — 267/275cul (1t)
...
## GREAT PEOPLE
- **GENERAL** 44pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
...
- **PROPHET** 77pts (+2.4/turn) — next recruit cost 240 — candidate: Martin Luther
- **SCIENTIST** 74pts (+2.4/turn) — next recruit cost 120 — candidate: Hildegard of Bingen
...
- majority religion: RELIGION_TAOISM
    ...
    - tiles: 17 owned, 5 worked | terrain: 9 plains, 5 plains_hills, 1 grass, 1 coast, 1 grass_hills | features: 1 marsh | improvements: 5 farm, 3 mine, 2 sphinx, 1 camp
    - top production options (showing 10 of 23): Scout (2t), Industrial Zone (2t), Archer (3t), Spearman (3t), Battering Ram (3t), Trader (4t), Horseman (4t), Builder (5t), Siege Tower (5t), Catapult (6t)
...
### Sais @ (62,26)
- pop 7 | grow 19t (food+8.0) | hous 7 | amen 2/3 | happ Displeased | border+14t | growth -15%
- yields: F22.0 P6.7 G1.9 S4.7 C3.9 Fa7.6
- prod sources: tiles 6.0, other +0.7 (see JSON for all yields)
- **producing:** Temple (107/120, 2t)
- defense: str 27 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 27): Temple (2t), Scout (5t), Archer (10t), Spearman (10t), Battering Ram (10t), Granary (10t), Trader (11t), Horseman (13t), Ancient Walls (13t), Water Mill (13t)
    ...
    - unavailable (showing 6 of 44; full list + reasons in JSON):
        ...
        - Library — This building requires a Campus district.
### SHEDET @ (66,25)
- pop 7 | grow 20t (food+7.0) | hous 8 | amen 1/3 | happ Displeased | border+10t | growth -15%
- yields: F21.0 P9.5 G0.0 S4.7 C4.8 Fa1.0
- prod sources: tiles 9.0, other +0.5 (see JSON for all yields)
- **producing:** Scout (15/30, 2t)
- defense: str 28 | garrison 200/200 | walls 100/100
    ...
    - tiles: 11 owned, 8 worked | terrain: 8 grass, 1 plains, 1 coast, 1 grass_hills | features: 1 forest, 1 marsh | improvements: 3 quarry, 2 farm, 1 sphinx
    - top production options (showing 10 of 24): Scout (2t), Archer (7t), Spearman (7t), Battering Ram (7t), Trader (8t), Horseman (9t), Water Mill (9t), Builder (10t), Siege Tower (11t), Catapult (13t)
...
- defense: str 25 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 25): Scout (5t), Builder (8t), Archer (10t), Spearman (11t), Battering Ram (11t), Trader (12t), Horseman (14t), Ancient Walls (14t), Water Mill (14t), Siege Tower (17t)
...
## UNITS (9)
- **Builder** #1703936 @(65,24) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch3 <IDLE>
- **Builder** #1572865 @(67,27) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch2 <IDLE>
...
## DIPLOMACY
- **envoys:** 1 in hand | 16/100 pts (+5.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 161 mil 159 | met T27 | OB from them
...
## REVEALED MAP
_626 revealed, 159 currently visible, 1 natural wonders_
...
61,15 1|p|||||||0||A-1|
62,15 1|d|||||||0|||
63,15 1|d||||1|||0|7:WARRIOR:100|A1|
64,15 1|d|||||||0|7:ARCHER:100||
65,15 1|dh||||1|||0|11:ARCHER:100||
...
64,24 1|g|||||||0||A3|
65,24 1|g||RICE||1|0||0|0:BUILDER:100|R/A3/F|
...
67,27 1|g|mar||||0||0|0:BUILDER:100|R/A5/F|
68,27 1|co|||||||0|||
69,27 1|oc|||||||0|||
52,28 0|co|||||||0|||
53,28 0|co||CRABS|||||0|||
...
- per-query timing (s): meta=0.374, choices=0.365, cities=0.407, units=0.342, map=0.361, diplo=0.362, religion=0.345, notif=0.346
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=121 generated_at=1785314042.634882 failed_sections=none counts: cities=4 units=9 tiles=626 majors=1 city_states=4 gossip=19 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=36344 -->
