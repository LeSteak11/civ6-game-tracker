# CIV6 COACH SNAPSHOT — turn 140
_Egypt (Cleopatra) — 580 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## EMPIRE
- **score:** 140
- **gold:** 610 (net +19.9 = yield 34.9 − maint 15.0)
- **science:** 26.1/turn
- **culture:** 21.1/turn
- **faith:** 1341 (+27.5/turn)
- **tourism:** 20.0/turn
- **military:** 245
- **techs / civics done:** 20 / 15
- **cities / units / pop:** 4 / 12 / 27
- **trade routes:** 1/1
...
## RESEARCH / CIVIC
- **tech:** Stirrups 293/390 (4t) — eureka:True
- **civic:** Mercenaries 166/290 (6t) — inspiration:True

### TECHS AVAILABLE (up to 10, sorted by turns)
- Stirrups ★ — 390sci (4t) — unlocks: Knight, Mamluk
...
- Mercenaries ★ — 290cul (6t) — unlocks: Sack, Professional Army, Trade Confederation
...
- **current:** Stirrups — 293/390sci (4t)
...
- **current:** Mercenaries — 166/290cul (6t)
...
## GREAT PEOPLE
- **GENERAL** 89pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
- **ADMIRAL** 0pts (+0.0/turn) — next recruit cost 120 — candidate: Leif Erikson
- **ENGINEER** 32pts (+2.4/turn) — next recruit cost 120 — candidate: Bi Sheng
- **MERCHANT** 0pts (+0.0/turn) — next recruit cost 60 — candidate: Zhang Qian
- **PROPHET** 142pts (+3.6/turn) — next recruit cost 240 — candidate: Martin Luther
- **SCIENTIST** 100pts (+2.4/turn) — next recruit cost 240 — candidate: Emilie du Chatelet
...
## CITIES (4)
### Râ-Kedet [CAP] @ (66,29)
- pop 5 | grow 29t (food+1.0) | hous 12 | amen 4/2 | happ Happy | border+21t | growth +10%
- yields: F11.0 P26.2 G22.0 S10.0 C6.8 Fa12.6
- prod sources: tiles 14.0, bldgs 6, adj 1, other +5.2 (see JSON for all yields)
- **producing:** Horseman (66/80, 1t)
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options (showing 10 of 26): Horseman (1t), Scout (2t), Trader (3t), Archer (3t), Spearman (3t), Battering Ram (3t), Builder (4t), Siege Tower (4t), Catapult (5t), Maryannu Chariot Archer (5t)
...
### Sais @ (62,26)
- pop 8 | grow 13t (food+9.0) | hous 9 | amen 3/3 | happ Content | border+21t
...
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - top production options (showing 10 of 28): Water Mill (4t), Scout (5t), Archer (9t), Spearman (10t), Battering Ram (10t), Trader (11t), Horseman (12t), Ancient Walls (12t), Builder (15t), Siege Tower (15t)
...
### SHEDET @ (66,25)
- pop 8 | grow 29t (food+13.0) | hous 8 | amen 2/3 | happ Displeased | border+5t | growth -15%
- yields: F29.0 P8.6 G2.9 S5.3 C6.1 Fa1.9
- prod sources: tiles 7.0, bldgs 1, other +0.6 (see JSON for all yields)
- **producing:** Campus (14/194, 19t)
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - tiles: 12 owned, 9 worked | terrain: 8 grass, 1 grass_mountain, 1 grass_hills, 1 coast, 1 plains | features: 1 marsh, 1 forest | improvements: 3 farm, 2 quarry, 2 sphinx
    ...
    - unavailable (showing 6 of 50; full list + reasons in JSON):
        ...
        - Oracle — blocked (reason not exposed by engine)
### Luxis @ (64,22)
- pop 6 | grow 9t (food+8.0) | hous 8 | amen 2/2 | happ Content | border+13t
...
- defense: str 35 | garrison 200/200 | walls 0/0
    ...
    - tiles: 11 owned, 7 worked | terrain: 7 grass, 1 plains, 1 plains_hills, 1 grass_mountain, 1 grass_hills | features: 2 forest, 2 jungle | improvements: 2 farm, 1 mine, 1 plantation
    - top production options (showing 10 of 27): Scout (3t), Archer (6t), Spearman (7t), Battering Ram (7t), Trader (8t), Horseman (8t), Ancient Walls (8t), Builder (10t), Siege Tower (10t), Catapult (12t)
...
## UNITS (12)
- **Builder** #1900544 @(63,21) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch1 <IDLE>
- **Scout** #1835009 @(73,10) | hp100/100 | mv3/3 | cs10 rs0 xp15/45 fort:2 <IDLE>
...
- **Settler** #1966088 @(67,34) | hp100/100 | mv2/2 | cs0 rs0 xp0/15
- **Man-At-Arms** #1769481 @(67,34) | hp100/100 | mv2/2 | cs45 rs0 xp15/45
- **Archer** #2031626 @(65,26) | hp100/100 | mv2/2 | cs15 rs25 xp0/15 fort:2
- **Archer** #2097163 @(67,25) | hp100/100 | mv2/2 | cs15 rs25 xp0/15

## DIPLOMACY
- **envoys:** 0 in hand | 11/100 pts (+5.0/turn — 1 envoys/threshold)
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 182 mil 135 | met T27
...
## REVEALED MAP
_661 revealed, 211 currently visible, 2 natural wonders_
...
69,18 1|d|||||||0|11:ARCHER:100|A1/F|
70,18 1|p|jun||||||0||A1|
71,18 0|p|for||||||0|||
72,18 0|d|||||||0||A1|
73,18 0|g|mar||||||0|||
...
54,24 1|g|||||||0||A1|
55,24 1|g|||FARM||8||0|8:WARRIOR:100||
...
67,34 1|g|||||||0|0:SETTLER:100;0:MAN_AT_ARMS:100|A1|
68,34 1|co|||||||0|||
69,34 1|co|||||||0|||
70,34 1|oc|||||||0|||
64,35 1|oc|||||||0|||
...
- per-query timing (s): meta=0.371, choices=0.357, cities=0.404, units=0.343, map=0.36, diplo=0.354, religion=0.34, notif=0.356
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=140 generated_at=1785397768.7303877 failed_sections=none counts: cities=4 units=12 tiles=661 majors=1 city_states=4 gossip=22 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=38191 -->
