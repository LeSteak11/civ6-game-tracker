# CIV6 COACH SNAPSHOT — turn 134
_Egypt (Cleopatra) — 450 AD / Medieval Era — Chieftain / Standard / Small Continents — schema coach-snapshot/1.4 coach 1.6.0_
...
## EMPIRE
- **score:** 137
- **gold:** 488 (net +9.3 = yield 22.3 − maint 13.0)
- **science:** 25.5/turn
- **culture:** 20.8/turn
- **faith:** 1176 (+27.5/turn)
- **tourism:** 20.0/turn
- **military:** 181
- **techs / civics done:** 19 / 15
- **cities / units / pop:** 4 / 9 / 26
- **trade routes:** 1/1
...
## RESEARCH / CIVIC
- **tech:** Celestial Navigation 66/120 (3t) — eureka:False [need: Improve 2 sea resources.]
- **civic:** Civil Service 75/275 (10t) — inspiration:False [need: Grow a city to 10 population.]

### TECHS AVAILABLE (up to 10, sorted by turns)
- Celestial Navigation  — 120sci (3t) — unlocks: Lighthouse, Great Lighthouse, Harbor, Royal Navy Dockyard — boost: Improve 2 sea resources.
...
- Civil Service  — 275cul (10t) — unlocks: Retainers, Meritocracy — inspiration: Grow a city to 10 population.
...
- **current:** Celestial Navigation — 66/120sci (3t)
...
- **current:** Civil Service — 75/275cul (10t)
...
## GREAT PEOPLE
- **GENERAL** 75pts (+2.4/turn) — next recruit cost 120 — candidate: Genghis Khan
- **ADMIRAL** 0pts (+0.0/turn) — next recruit cost 120 — candidate: Leif Erikson
- **ENGINEER** 18pts (+2.4/turn) — next recruit cost 120 — candidate: Bi Sheng
- **MERCHANT** 0pts (+0.0/turn) — next recruit cost 60 — candidate: Zhang Qian
- **PROPHET** 120pts (+3.5/turn) — next recruit cost 240 — candidate: Martin Luther
- **SCIENTIST** 86pts (+2.4/turn) — next recruit cost 240 — candidate: Emilie du Chatelet
...
- majority religion: RELIGION_TAOISM
    ...
    - top production options (showing 10 of 25): Scout (1t), Settler (2t), Archer (2t), Trader (3t), Spearman (3t), Battering Ram (3t), Horseman (3t), Builder (4t), Catapult (4t), Siege Tower (4t)
...
### Sais @ (62,26)
- pop 8 | grow 19t (food+9.0) | hous 9 | amen 3/3 | happ Content | border+1t
...
- defense: str 37 | garrison 200/200 | walls 0/0
    ...
    - tiles: 13 owned, 9 worked | terrain: 9 grass, 2 plains, 1 plains_hills, 1 grass_hills | features: 2 jungle, 1 marsh | improvements: 2 pasture, 1 plantation, 1 farm
    - top production options (showing 10 of 27): Scout (5t), Archer (9t), Spearman (10t), Battering Ram (10t), Water Mill (10t), Trader (11t), Horseman (12t), Ancient Walls (12t), Builder (15t), Siege Tower (15t)
...
- defense: str 38 | garrison 200/200 | walls 100/100
    ...
    - top production options (showing 10 of 25): Scout (4t), Archer (5t), Spearman (7t), Battering Ram (7t), Trader (8t), Horseman (9t), Builder (11t), Siege Tower (11t), Catapult (13t), Maryannu Chariot Archer (13t)
    - ...15 more options in JSON
    - unavailable (showing 6 of 48; full list + reasons in JSON):
        ...
        - Shrine — This building requires a Holy Site district.
### Luxis @ (64,22)
- pop 5 | grow 7t (food+5.0) | hous 8 | amen 2/2 | happ Content | border+20t
- yields: F15.0 P7.0 G8.0 S4.5 C3.5 Fa1.0
- prod sources: tiles 6.0, other +1.0 (see JSON for all yields)
- **producing:** Water Mill (34/80, 7t)
- defense: str 35 | garrison 200/200 | walls 0/0
    - district `CITY_CENTER` @ (64,22)
    - buildings in `CITY_CENTER`: Monument, Granary
    - tiles: 11 owned, 6 worked | terrain: 7 grass, 1 plains_hills, 1 grass_mountain, 1 plains, 1 grass_hills | features: 2 forest, 2 jungle | improvements: 1 farm, 1 plantation
    - top production options (showing 10 of 27): Scout (5t), Water Mill (7t), Archer (9t), Spearman (10t), Battering Ram (10t), Trader (11t), Horseman (12t), Ancient Walls (12t), Builder (15t), Siege Tower (15t)
    - ...17 more options in JSON
    - unavailable (showing 6 of 48; full list + reasons in JSON):
        - Great Library — Requires Library [reconstructed: BuildingPrereqs]
        - Stonehenge — blocked (reason not exposed by engine)
...
## UNITS (9)
- **Builder** #1900544 @(62,21) | hp100/100 | mv2/2 | cs0 rs0 xp0/15 ch3 <IDLE>
- **Scout** #1835009 @(73,10) | hp58/100 | mv3/3 | cs10 rs0 xp15/15 fort:2
...
### MAJORS MET
- **Sumeria (Gilgamesh)** — DIPLO_STATE_DECLARED_FRIEND | vis 1 | score 175 mil 160 | met T27 | OB from them
...
## REVEALED MAP
_657 revealed, 192 currently visible, 2 natural wonders_
...
- per-query timing (s): meta=0.376, choices=0.357, cities=0.393, units=0.347, map=0.364, diplo=0.359, religion=0.347, notif=0.345
- **failures at runtime:**
...
<!-- coach snapshot: schema=coach-snapshot/1.4 turn=134 generated_at=1785315542.1879752 failed_sections=none counts: cities=4 units=9 tiles=657 majors=1 city_states=4 gossip=21 rival_cities=10 tech_tree=68 civic_tree=51 md_chars=38073 -->
